...
export function ChatList({ chats, onChatSelect, searchQuery, onSearchChange }: ChatListProps) {
  const { t } = useLanguage();
  ...
  return (
    <div className="flex-1 bg-background">
      ...
      <div className="bg-card px-4 pt-12 pb-4">
        <div className="mb-4">
          <h1 className="text-3xl font-semibold text-foreground">{t('messages.title')}</h1>
        </div>
      ...
      <div className="px-4 py-2 pb-20">
            ...
            <div className="flex items-start justify-between">
              <div className="flex items-start space-x-3 flex-1">
                ...
                <div className="flex-1">
                  <h4 className="font-medium text-foreground mb-1">{t('messages.chatFeaturesTitle')}</h4>
        ...
        {sortedChats.length === 0 && searchQuery && (
          <div className="text-center py-12">
            ...
            <h3 className="text-lg font-medium text-foreground mb-2">{t('messages.noConversationsFound')}</h3>
            <p className="text-muted-foreground">{t('messages.tryDifferentSearch')}</p>
          </div>
        )}
        ...
        {chats.length === 0 && (
          <div className="text-center py-16">
            ...
            <h3 className="text-xl font-medium text-foreground mb-2">{t('messages.noMessagesYet')}</h3>
