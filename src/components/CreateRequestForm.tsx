...
import { Plus, Upload, Calendar, MapPin, DollarSign, Truck, User as UserIcon, X } from 'lucide-react';
...
export function CreateRequestForm({ user }: CreateRequestFormProps) {
  ...
  return (
    <>
      <CreateFormLoadingOverlay type="request" isVisible={isSubmitting} />
          ...
          <div className="flex items-start justify-between">
            <div className="flex items-start space-x-3 flex-1">
              ...
              <div className="flex-1">
                <h4 className="font-medium text-foreground mb-1">{t('createRequest.infoBoxTitle')}</h4>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="relative">
              ...
              <Input
                placeholder={t('createRequest.budgetMinPlaceholder')}
            ...
            <div className="relative">
              <DollarSign className="absolute left-3 top-3 h-4 w-4 text-muted-foreground" />
              <Input
                placeholder={t('createRequest.budgetMaxPlaceholder')}
          ...
          <Select value={formData.productOrigin} onValueChange={(value) => setFormData({...formData, productOrigin: value})}>
            <SelectTrigger className="bg-input-background border-border">
              <div className="flex items-center">
                ...
                <SelectValue placeholder={t('createRequest.selectCountryRegion')} />
              </div>
            </SelectTrigger>
            <SelectContent>
        ...
        <div>
          ...
          <div className="relative">
            ...
            <Input
              placeholder={t('createRequest.purchasingLocationPlaceholder')}
        ...
        <div>
          ...
          <div className="flex gap-2 mb-3">
            <Input
              placeholder={t('createRequest.requirementPlaceholder')}
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            >
              ...
              <div className="text-left">
                ...
                <div className="text-xs opacity-70">{t('createRequest.shipToMeDescription')}</div>
              </div>
            </Button>
            <Button
              type="button"
            ...
            >
              ...
              <div className="text-left">
                ...
                <div className="text-xs opacity-70">{t('createRequest.deliverPersonallyDescription')}</div>
              </div>
            </Button>
          </div>
          <p className="text-xs text-muted-foreground mt-2">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                <MapPin className="absolute left-3 top-3 h-4 w-4 text-muted-foreground" />
                <Input
                  placeholder={t('createRequest.meetingLocationPlaceholder')}
        ...
        <div className="pt-4">
          ...
          >
            {isSubmitting ? t('create.creatingRequest') : t('createRequest.createRequest')}
          </Button>
        </div>
      </form>
    </div>
