...
import { Plus, Upload, MapPin, DollarSign, Package, Truck, X, Camera, User as UserIcon, Plane, Zap } from 'lucide-react';
...
export function CreateOfferForm({ user }: CreateOfferFormProps) {
  ...
  const deliveryOptionsConfig = useMemo(() => [
    { id: 'local-pickup', label: t('createOffer.deliverPersonally'), description: t('createOffer.deliverPersonallyDescription'), icon: UserIcon },
    { id: 'domestic-shipping', label: t('createOffer.domesticShipping'), description: t('createOffer.domesticShippingDescription'), icon: Truck },
    { id: 'international-shipping', label: t('createOffer.international'), description: t('createOffer.internationalDescription'), icon: Plane },
    { id: 'express-delivery', label: t('createOffer.expressDelivery'), description: t('createOffer.expressDeliveryDescription'), icon: Zap }
  ], [t]);
  ...
  return (
    <>
      <CreateFormLoadingOverlay type="offer" isVisible={isSubmitting} />
          ...
          <div className="flex items-start justify-between">
            <div className="flex items-start space-x-3 flex-1">
              ...
              <div className="flex-1">
                <h4 className="font-medium text-foreground mb-1">{t('createOffer.infoBoxTitle')}</h4>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          <Textarea
            placeholder={t('createOffer.serviceDescriptionPlaceholder')}
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-3">
            {deliveryOptionsConfig.map((option) => {
              const isSelected = formData.deliveryOptions.includes(option.id);
        ...
        <div className="pt-4">
          ...
          >
            {isSubmitting ? t('create.creatingOffer') : t('createOffer.createOffer')}
          </Button>
        </div>
      </form>
    </div>
