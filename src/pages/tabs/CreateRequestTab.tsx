        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <Input
                placeholder={t(
                  'createRequest.designatedLocationPlaceholder'
                )}
          ...
          <div>
            ...
            <div className="flex gap-2 mb-3">
              <Input
                placeholder={t(
                  'createRequest.addRequirementPlaceholder'
                )}
              ...
              >
                ...
                <div className="text-left">
                  ...
                  <div className="text-xs opacity-70">
                    {t('createRequest.packageDelivery')}
                  </div>
                </div>
              </Button>
              <Button
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <Input
                    placeholder={t(
                      'createRequest.locationPlaceholder'
                    )}
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <Input
                    placeholder={t(
                      'createRequest.stateProvincePlaceholder'
                    )}
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <Input
                    placeholder={t(
                      'createRequest.countryPlaceholder'
                    )}
