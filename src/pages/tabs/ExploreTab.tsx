...
export function ExploreTab({ user }: ExploreTabProps) {
  const { t } = useLanguage();
  const navigate = useNavigate();
  const [favorites, setFavorites] = useState<Set<number>>(new Set());

  const [visibleRecommendations, setVisibleRecommendations] =
    useState(8);
  ...
  //  data with images and better structure
  const trendingItems = [
    {
      id: 1,
      ...
      description:
        'High-quality office equipment for small to medium businesses',
    ...
    },
    {
      ...
      bids: 12,
      image:
        'https://images.unsplash.com/photo-1756402664856-91a90f90b70b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjb25zdHJ1Y3Rpb24lMjB0b29scyUyMGluZHVzdHJpYWwlMjBlcXVpcG1lbnR8ZW58MXx8fHwxNzU4NzA1NjE1fDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
      description:
        'Professional-grade construction tools for renovation project',
  ...
  const systemRecommendations = [
    ...
    },
    {
      ...
      image:
        'https://images.unsplash.com/photo-1677417281771-2a861ce553ff?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxzcG9ydHMlMjBlcXVpcG1lbnQlMjBmaXRuZXNzfGVufDF8fHx8MTc1ODYxOTU5MXww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
    ...
    },
    {
      ...
      image:
        'https://images.unsplash.com/photo-1683905761552-ccc9d133b092?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxhcnQlMjBzdXBwbGllcyUyMGNyZWF0aXZlfGVufDF8fHx8MTc1ODcwNjk1Nnww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
    ...
    },
    {
      ...
      image:
        'https://images.unsplash.com/photo-1753103461856-352241a33626?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxmdXJuaXR1cmUlMjBtb2Rlcm4lMjBob21lfGVufDF8fHx8MTc1ODcxMDMxMXww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
  ...
  const loadMoreRecommendations = () => {
    ...
    setTimeout(() => {
      setVisibleRecommendations((prev) =>
        Math.min(prev + 8, combinedRecommendations.length)
      );
      ...
      <div className="px-4 py-6 space-y-6">
        ...
        <section>
          ...
          <div className="grid grid-cols-2 gap-3">
            {shoppingOffers.slice(0, 4).map((offer) => (
              <div
                key={offer.id}
              ...
              >
                <div className="relative mb-3">
                  ...
                  >
                    <Heart
                      className={`h-4 w-4 ${
                        favorites.has(offer.id) ? 'fill-current' : ''
                      }`}
                    />
                  </Button>
              ...
              .map((item) => (
                ...
                >
                  <div className="relative mb-3">
                    ...
                    <Badge
                      className={`absolute top-2 left-2 text-white text-xs px-2 py-1 ${
                        item.type === 'request'
                          ? 'bg-blue-600'
                          : 'bg-primary'
                      }`}
