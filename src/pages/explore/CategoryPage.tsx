...
export function CategoryPage({
      ...
      requests: [
        {
          ...
          offers: 12,
          image:
            'https://images.unsplash.com/photo-1645633090316-bcaafbfd4c4d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxzaGVycGElMjBjb2F0JTIwd2ludGVyJTIwamFja2V0fGVufDF8fHx8MTc1ODcxMjE3Nnww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
        },
        {
          id: 'fashion-req-2',
          ...
          timeAgo: '5 hours ago',
          description:
            'Seeking authentic vintage leather jacket from Tokyo vintage stores',
          user: 'Marcus Johnson',
          offers: 8,
          image:
            'https://images.unsplash.com/photo-1521223890158-f9f7c3d5d504?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx2aW50YWdlJTIwbGVhdGhlciUyMGphY2tldHxlbnwxfHx8fDE3NTg3MTIxOTF8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
        },
      ],
      offers: [
        {
          ...
          timeAgo: '1 hour ago',
          description:
            'Authentic designer handbags from Milan fashion district',
          image:
            'https://images.unsplash.com/photo-1664764966090-e5d93ae48dc2?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxsdXh1cnklMjB0b3RlJTIwYmFnJTIwaGFuZGJhZ3xlbnwxfHx8fDE3NTg3MTIxODJ8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
        },
        {
          id: 'fashion-offer-2',
          ...
          timeAgo: '3 hours ago',
          description:
            'Trendy streetwear from Seoul fashion districts',
          image:
            'https://images.unsplash.com/photo-1737666636073-f15d9762cf83?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxidWNrZXQlMjBoYXQlMjBjYXAlMjBzdHJlZXR3ZWFyfGVufDF8fHx8MTc1ODcxMjE4NXww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
        },
      ],
    },
    electronics: {
      ...
      requests: [
        {
          ...
          offers: 15,
          image:
            'https://images.unsplash.com/photo-1667178173387-7e0cb51c0b4f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx3aXJlbGVzcyUyMGVhcmJ1ZHMlMjBoZWFkcGhvbmVzfGVufDF8fHx8MTc1ODYwNjc1MXww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
        },
      ],
      offers: [
        {
  ...
  const allItems = [
    ...
    ...currentCategory.offers.map((item) => ({
      ...item,
      type: 'offer',
    })),
  ];
