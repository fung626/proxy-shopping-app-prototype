...
export function IdentityVerificationPage({}: IdentityVerificationPageProps) {
  ...
  const documentTypes = [
    {
      id: 'passport',
      name: t('document.passport'),
      description: t('document.passportDescription'),
    },
    {
      id: 'drivers-license',
      name: t('document.driversLicense'),
      description: t('document.driversLicenseDescription'),
    },
    {
      id: 'national-id',
      name: t('document.nationalId'),
      description: t('document.nationalIdDescription'),
    },
    {
      id: 'military-id',
      name: t('document.militaryId'),
      description: t('document.militaryIdDescription'),
    },
  ];
                ...
                {t('document.enterInformation', {
                  document:
                    documentTypes
                      ...
                      ?.name?.toLowerCase() || t('document.document'),
                })}
              </p>
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-muted/50 rounded-lg p-4 mb-6">
              <h4 className="font-medium text-foreground mb-2">
                {t('identityVerification.guidelines')}
              </h4>
