...
interface SignInFormProps {
  onSignIn: (credentials: { email: string; password: string; loginType: 'email' | 'phone' }) => void;
  onSwitchToSignUp: () => void;
  onForgotPassword?: () => void;
  onBack?: () => void;
}

export function SignInForm({ onSignIn, onSwitchToSignUp, onForgotPassword, onBack }: SignInFormProps) {
  const { t } = useLanguage();
    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <div className="flex-1 px-6 py-8">
        <div className="max-w-sm mx-auto">
          {/* Title */}
          <div className="mb-8">
            <h1 className="text-3xl font-semibold text-foreground mb-3">{t('auth.signIn')}</h1>
          ...
          <div className="mt-8">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-xs">
                <span className="bg-background px-4 text-muted-foreground">{t('auth.orSignInWith')}</span>
              </div>
            </div>
          ...
          <div className="mt-8 text-center">
            <span className="text-muted-foreground text-sm">{t('auth.dontHaveAccount')} </span>
            <Button
              variant="link"
