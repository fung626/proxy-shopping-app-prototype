...
export function TransactionPasswordPage({
    ...
    if (isEnabled) {
      ...
      if (
        ...
        newErrors.currentPassword = t(
          'transactionPassword.currentPasswordRequired'
        );
      }

      if (!newPasswordString || newPasswordString.length !== 6) {
        newErrors.newPassword = t(
          'transactionPassword.newPasswordRequired'
        );
      }
      ...
      if (
        ...
        newErrors.confirmPassword = t(
          'transactionPassword.confirmPasswordRequired'
        );
      } else if (newPasswordString !== confirmPasswordString) {
        newErrors.confirmPassword = t(
          'transactionPassword.passwordsDoNotMatch'
        );
      }
    }
  ...
  const isFormValid = () => {
    ...
    const hasConfirmPasswordError =
      !confirmPasswordString ||
      confirmPasswordString.length !== 6 ||
      newPasswordString !== confirmPasswordString;
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      console.log(
        'Saving transaction password settings:',
        updatedUser
      );
      navigate(-1);
    } catch (error) {
            ...
            <div className="flex items-center justify-between">
              <div>
                <h3 className="font-medium text-foreground mb-1">
                  {t('transactionPassword.enableTitle')}
                </h3>
                <p className="text-sm text-muted-foreground">
                  {isEnabled
                    ? t('transactionPassword.enabled')
                    : t('transactionPassword.disabled')}
                </p>
              </div>
              <Switch
                checked={isEnabled}
            ...
            <div className="space-y-6">
              ...
              <div className="bg-muted/30 rounded-xl p-4">
                <h4 className="text-sm font-medium mb-3 text-foreground">
                  {t('transactionPassword.requirements')}
                </h4>
