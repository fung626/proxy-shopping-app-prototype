...
export function AllOffersPage({ onBack }: AllOffersPageProps) {
  const { t } = useLanguage();
  ...
  const allOffers = [
    ...
    },
    {
      ...
      status: 'active' as const,
      image:
        'https://images.unsplash.com/photo-1584917865442-de89df76afd3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxsdXh1cnklMjBoYW5kYmFnJTIwaXRhbGlhbiUyMGxlYXRoZXJ8ZW58MXx8fHwxNzU4NzA1NjMzfDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
    ...
    },
    {
      ...
      status: 'active' as const,
      image:
        'https://images.unsplash.com/photo-1556679343-c7306c1976bc?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxicml0aXNoJTIwdGVhJTIwZ291cm1ldCUyMGZvb2R8ZW58MXx8fHwxNzU4NzA1NjM1fDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
