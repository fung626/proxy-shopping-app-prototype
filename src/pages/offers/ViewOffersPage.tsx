...
export function ViewOffersPage({
  ...
  const handleAcceptOffer = (offer: AgentOffer) => {
    ...
    const paymentOffer = {
      ...
      estimatedDelivery:
        offer.estimatedTime || offer.estimatedDelivery,
      ...
      '1': [
        {
          ...
          rating: 5,
          comment:
            'Sarah was amazing! She found the exact sneakers I wanted and even got them at a discount. Communication was excellent throughout.',
        ...
        },
        {
          ...
          rating: 5,
          comment:
            'Perfect service! Got authentic Jordan 1s in perfect condition. Will definitely use Sarah again.',
        ...
        },
        {
          ...
          rating: 4,
          comment:
            'Great agent, very professional. Only minor issue was shipping took a day longer than expected.',
        ...
        },
        {
          ...
          rating: 5,
          comment:
            'Sarah knows her stuff! She helped me authenticate the items and provided excellent photos.',
      ...
      '2': [
        {
          ...
          rating: 5,
          comment:
            'Mike is super fast and reliable. Found my items within hours and kept me updated the whole time.',
        ...
        },
        {
          ...
          rating: 4,
          comment:
            'Good service overall. Mike found good deals and the items arrived quickly.',
        ...
        },
        {
          ...
          rating: 5,
          comment:
            'Excellent agent! Mike went above and beyond to find exactly what I needed.',
      ...
      '3': [
        {
          ...
          rating: 5,
          comment:
            'Emma is incredibly detail-oriented. She caught issues with quality that I would have missed.',
        ...
        },
        {
          ...
          rating: 4,
          comment:
            'Very thorough agent. Emma takes her time to ensure everything is perfect.',
        ...
        },
        {
          ...
          rating: 5,
          comment:
            'Outstanding service! Emma found luxury items I thought were impossible to get.',
  ...
  const defaultOffers: AgentOffer[] = [
    {
      ...
      totalCost: '$265',
      description:
        'Specialized in sneaker authentication and limited edition releases. I have connections with major retailers and can source hard-to-find items.',
    ...
    },
    {
      ...
      totalCost: '$255',
      description:
        'Fast and reliable shopping agent with extensive knowledge of retail locations and discount opportunities.',
    ...
    },
    {
      ...
      totalCost: '$260',
      description:
        'Detail-oriented agent with focus on quality verification and customer satisfaction. Great for complex requests.',
              ...
              <div className="flex items-start space-x-3 mb-4">
                ...
                <div className="text-right">
                  ...
                  <div className="text-xs text-muted-foreground space-y-0.5">
                    <div>
                      {t('payment.cost')}: {offer.estimatedCost}
                    </div>
                    <div>
                      {t('payment.fee')}: {offer.serviceFee}
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-3 mb-4">
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <span>
                      {t('agent.respondsIn')} {offer.responseTime}
                    </span>
                  </div>
                </div>
