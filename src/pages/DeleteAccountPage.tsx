...
export function DeleteAccountPage({ onBack, onComplete }: DeleteAccountPageProps) {
  const { t } = useLanguage();
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="p-4">
        <div className="mb-6">
          ...
          <h2 className="text-xl font-semibold mb-2">{t('deleteAccount.deleteYourAccount')}</h2>
        ...
        <div className="mb-6 p-4 bg-red-50 border border-red-200 rounded-lg">
          <div className="flex items-start space-x-3">
            ...
            <div>
              <h4 className="font-medium text-red-900 mb-2">{t('deleteAccount.whatWillBeDeleted')}</h4>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            <Label htmlFor="password">{t('deleteAccount.confirmPassword')}</Label>
            <Input
              id="password"
              type="password"
              value={password}
          ...
          <div className="p-4 bg-muted/50 rounded-lg">
            <h4 className="font-medium mb-2">{t('deleteAccount.alternatives')}</h4>
          ...
          <div className="space-y-3">
            ...
            >
              {isLoading ? t('deleteAccount.deleting') : t('deleteAccount.deleteMyAccount')}
            </Button>
