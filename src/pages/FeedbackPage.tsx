...
import { ArrowLeft, Star, User, MessageCircle } from 'lucide-react';
...
export function FeedbackPage({ request, onBack, onSubmitFeedback }: FeedbackPageProps) {
  const { t } = useLanguage();
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="p-4 space-y-6">
        ...
        <div className="p-4 bg-muted/30 rounded-lg">
          ...
          <div className="flex items-center space-x-2">
            ...
            <span className="text-sm text-muted-foreground">
              {t('feedback.rateYour')} {recipientType}: <span className="font-medium text-foreground">{recipientName}</span>
            </span>
          </div>
        </div>
        ...
        <div className="space-y-4">
          <h3 className="font-semibold text-foreground">{t('feedback.overallRating')}</h3>
        ...
        {/* Comment Section */}
        <div className="space-y-4">
          <h3 className="font-semibold text-foreground">{t('feedback.yourComments')}</h3>
          ...
          <div className="space-y-3">
            ...
            <Textarea
              placeholder={t('feedback.commentPlaceholder', { name: recipientName })}
              value={comment}
        ...
        <div className="p-4 bg-blue-50 dark:bg-blue-950/30 rounded-lg border border-blue-200 dark:border-blue-800">
          <h4 className="font-medium text-blue-900 dark:text-blue-100 mb-2">{t('feedback.guidelines')}</h4>
