    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="px-4 py-4">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-3">
              {supportOptions.map((option) => {
                ...
                return (
                  <div
                    key={option.title}
                    className="p-4 border border-border rounded-lg bg-input-background"
                  >
          ...
          <div>
            <label className="block text-sm font-medium text-foreground mb-2">
              {t('support.helpfulResources')}
            </label>
            <div className="space-y-3">
              <Button
                variant="outline"
                className="w-full justify-start h-auto py-3 bg-input-background border-border"
              >
                <div className="text-left">
                  ...
                  <div className="text-sm text-muted-foreground">
                    {t('support.userGuideDescription')}
                  </div>
                </div>
              </Button>
              <Button
              ...
              >
                <div className="text-left">
                  ...
                  <div className="text-sm text-muted-foreground">
                    {t('support.videoTutorialsDescription')}
                  </div>
                </div>
              </Button>
              <Button
              ...
              >
                <div className="text-left">
                  <div className="font-medium">
                    {t('support.apiDocumentation')}
                  </div>
                  <div className="text-sm text-muted-foreground">
                    {t('support.apiDocumentationDescription')}
                  </div>
                </div>
              </Button>
            </div>
