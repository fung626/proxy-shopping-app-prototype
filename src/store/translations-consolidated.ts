// Consolidated translations for better reliability
export const translations = {
  en: {
    ...
    'common.searchInCategory': 'Search in {category}',
    'common.itemsFound': '{count} items found',
    'common.noResults': 'No results found',
    'common.noItemsFound': 'No items found',
    'common.noItemsInCategory': 'No items found in this category',
    'common.searchOffers': 'Search offers...',
    'common.offersFound': '{count} offers found',
    'common.searchRequests': 'Search requests...',
    ...
    'search.tryDifferentTerms': 'Try different search terms',
    ...
    // Explore
    'explore.allOffers': 'All Offers',
    'explore.allRequests': 'All Requests',
    ...
    'messages.chatFeaturesDescription': 'Communicate directly with agents and clients',
    'messages.agentBadge': 'Agent',
    'messages.today': 'Today',
    'messages.messageAgentPlaceholder': 'Type a message to agent...',

    // Create Request
    'createRequest.budgetRangeDescription': 'Set your budget range to help agents understand your price expectations',
    ...
    'offerDetails.freeCommunicationDesc': 'Direct communication with agent',
    'offerDetails.purchaseReceipt': 'Purchase Receipt',
    'offerDetails.purchaseReceiptDesc': 'Official receipt for all purchases',
    'offerDetails.trackingInformation': 'Tracking Information',
    'offerDetails.trackingInformationDesc': 'Real-time package tracking',
    ...
    'offerDetails.productCostNote': 'Product cost will be added at checkout',
    'offerDetails.agentStats': 'Agent Statistics',

    // All Agents Page
    'allAgents.title': 'All Agents',
    'allAgents.subtitle': 'Browse all available shopping agents',
    'allAgents.searchPlaceholder': 'Search agents...',
    'allAgents.specialty': 'Specialty',
    'allAgents.allSpecialties': 'All Specialties',
    'allAgents.technologyShopping': 'Technology Shopping',
    'allAgents.fashionLuxury': 'Fashion & Luxury',
    'allAgents.beautySkincare': 'Beauty & Skincare',
    'allAgents.electronicsTech': 'Electronics & Tech',
    'allAgents.homeAppliances': 'Home & Appliances',
    'allAgents.gaming': 'Gaming',
    'allAgents.luxuryWatches': 'Luxury Watches',
    'allAgents.allLocations': 'All Locations',
    'allAgents.northAmerica': 'North America',
    'allAgents.europe': 'Europe',
    'allAgents.asia': 'Asia',
    'allAgents.highestRated': 'Highest Rated',
    'allAgents.mostReviews': 'Most Reviews',
    'allAgents.mostOrders': 'Most Orders',
    'allAgents.fastestResponse': 'Fastest Response',
    'allAgents.highestSuccessRate': 'Highest Success Rate',
    'allAgents.agents': 'agents',
    'allAgents.found': 'found',
    'allAgents.ordersCompleted': 'orders completed',
    'allAgents.successRate': 'success rate',
    'allAgents.responds': 'responds',
    'allAgents.avgDelivery': 'avg delivery',
    'allAgents.joined': 'joined',
    'allAgents.languages': 'Languages',
    'allAgents.contactAgent': 'Contact Agent',
    ...
    'preferences.categories.home': 'Furniture & Home',
    'preferences.categories.food': 'Food',
    'preferences.categories.electronics': 'Electronics',
    'preferences.categories.toys': 'Toys & Games',
    'preferences.categories.stationery': 'Stationery & Office',
    'preferences.categories.fashion': 'Fashion & Clothing',
    'preferences.categories.sports': 'Sports & Fitness',
    'preferences.categories.accessories': 'Accessories',
    'preferences.categories.bags': 'Bags & Luggage',
    'preferences.categories.automotive': 'Automotive',
    'preferences.categories.others': 'Others',
    ...
    'auth.demoModeDescription': 'Explore the app with demo data',
    ...
    'explore.featuredCategories': 'Featured Categories',
    'explore.popularCategories': 'Popular Categories',
    'explore.recentRequests': 'Recent Requests',
    'explore.topOffers': 'Top Offers',
    'explore.topShoppingOffers': 'Top Shopping Offers',
    ...
    'orders.packageShipped': 'Package Shipped',
    'orders.shoppingAgent': 'Shopping Agent:',
    'orders.client': 'Client:',
    'orders.details': 'Details',
    'orders.viewFeedback': 'View Feedback',
    'orders.leaveFeedback': 'Leave Feedback',
    'orders.contactAgent': 'Contact Agent',
    'orders.viewOffers': 'View Offers',
    'orders.contactClient': 'Contact Client',
    'orders.request': 'Request',
    'orders.offer': 'Offer',
    'orders.stepOf': 'Step {current} of {total}',

    // Order Status
    'orders.status.active': 'Active',
    'orders.status.inProgress': 'In Progress',
    'orders.status.itemsPurchased': 'Items Purchased',
    'orders.status.purchased': 'Purchased',
    'orders.status.packageShipped': 'Package Shipped',
    ...
    'orders.steps.itemsBoughtByAgent': 'Items bought by agent',
    'orders.steps.packageShipped': 'Package Shipped',
    'orders.steps.packageSentOut': 'Package sent out',
    'orders.steps.delivered': 'Delivered',
    'orders.steps.orderComplete': 'Order complete',

    // Order Steps - Agent View
    'orders.steps.requestAccepted': 'Request Accepted',
    ...
    'messages.description': 'Chat with agents and clients',
    ...
    'messages.ago': 'ago',
    'messages.now': 'now',
    'messages.minuteAgo': '1 min ago',
    'messages.minutesAgo': '{count} mins ago',
    'messages.hourAgo': '1 hour ago',
    'messages.hoursAgo': '{count} hours ago',
    'messages.dayAgo': '1 day ago',
    'messages.daysAgo': '{count} days ago',
    'messages.weekAgo': '1 week ago',
    'messages.weeksAgo': '{count} weeks ago',
    'messages.monthAgo': '1 month ago',
    'messages.monthsAgo': '{count} months ago',
    'messages.typing': 'Typing...',
    'messages.typingIndicator': '{name} is typing...',
    'messages.messageDelivered': 'Delivered',
    'messages.messageRead': 'Read',
    'messages.messageSent': 'Sent',
    'messages.messageSending': 'Sending...',
    'messages.messageTypeHere': 'Type a message...',
    'messages.sendMessage': 'Send message',
    'messages.attachFile': 'Attach file',
    'messages.attachImage': 'Attach image',
    'messages.attachLocation': 'Share location',
    'messages.attachDocument': 'Attach document',
    'messages.photoMessage': 'Photo',
    'messages.locationMessage': 'Location',
    'messages.documentMessage': 'Document',
    'messages.newConversation': 'New Conversation',
    'messages.conversationWith': 'Conversation with {name}',
    'messages.requestTitle': 'Request: {title}',
    ...
    'profile.transactionPassword': 'Transaction Password',
    'profile.transactionPasswordEnabled': 'Additional security for payments',
    'profile.transactionPasswordDisabled': 'Not set up',
    'profile.biometricAuth': 'Biometric Authentication',
    'profile.biometricAuthEnabled': 'Use fingerprint or face recognition',
    'profile.biometricAuthDisabled': 'Not set up',
    ...
    'transactionPassword.title': 'Transaction Password',
    'transactionPassword.enableTitle': 'Enable Transaction Password',
    'transactionPassword.enableDescription': 'Add an extra layer of security for payments and sensitive transactions.',
    'transactionPassword.enabled': 'Enabled',
    'transactionPassword.disabled': 'Disabled',
    'transactionPassword.updatePassword': 'Update Password',
    'transactionPassword.setPassword': 'Set Password',
    'transactionPassword.currentPassword': 'Current Password',
    'transactionPassword.enterCurrentPassword': 'Enter your current password',
    'transactionPassword.newPassword': 'New Password',
    'transactionPassword.password': 'Password',
    'transactionPassword.enterNewPassword': 'Enter your new password',
    'transactionPassword.confirmPassword': 'Confirm Password',
    'transactionPassword.confirmNewPassword': 'Confirm your new password',
    'transactionPassword.currentPasswordRequired': 'Current password is required',
    'transactionPassword.newPasswordRequired': 'New password is required',
    'transactionPassword.confirmPasswordRequired': 'Please confirm your password',
    'transactionPassword.passwordTooShort': 'Password must be at least 6 characters',
    'transactionPassword.passwordsDoNotMatch': 'Passwords do not match',
    'transactionPassword.requirements': 'Password Requirements',
    'transactionPassword.requirementLength': 'At least 6 characters long',
    'transactionPassword.requirementMatch': 'Passwords match',
    'transactionPassword.infoTitle': 'What is a transaction password?',
    'transactionPassword.infoDescription': 'A transaction password provides additional security for payments and sensitive operations. It\'s different from your login password and helps protect your financial transactions.',
    ...
    'editProfile.nicknamePlaceholder': 'Enter your nickname',
    ...
    'editProfile.selectCountry': 'Select your country',
    'editProfile.bio': 'Bio',
    ...
    // Create
    'create.title': 'Create',
    'create.description': 'Create new shopping requests or offers',
    'create.newRequest': 'New Request',
    'create.newOffer': 'New Offer',
    'create.request': 'Request',
    'create.offer': 'Offer',
    'create.creatingRequest': 'Creating Request',
    ...
    'createRequest.budgetMinPlaceholder': 'Min amount',
    ...
    'createRequest.shippingInformation': 'Shipping Information',
    'createRequest.fullName': 'Full Name',
    'createRequest.fullNamePlaceholder': 'Enter recipient name',
    ...
    'createRequest.statePlaceholder': 'Enter state or province',
    'createRequest.postalCode': 'Postal Code',
    ...
    'createOffer.fixedRate': 'Fixed Rate',
    'createOffer.percentage': 'Percentage',
    'createOffer.feeAmount': 'Fee Amount',
    'createOffer.feeAmountPlaceholder': 'Enter amount',
    'createOffer.feePercentage': 'Fee Percentage',
    'createOffer.feePercentagePlaceholder': 'Enter percentage',
    'createOffer.minimumOrder': 'Minimum Order Value',
    'createOffer.minimumOrderPlaceholder': 'Minimum order amount',
    'createOffer.estimatedTime': 'Estimated Time',
    ...
    'createOffer.domesticShippingDescription': 'Ship within country',
    'createOffer.international': 'International',
    'createOffer.internationalDescription': 'Ship worldwide',
    ...
    'createRequest.state': 'State/Province',
    'createRequest.statePlaceholder': 'State/Province',
    'createRequest.postalCode': 'Postal Code',
    'createRequest.postalCodePlaceholder': 'Postal/ZIP code',
    'createRequest.country': 'Country',
    'createRequest.selectCountry': 'Select country',
    ...
    'requestSteps.client.itemsBoughtByAgent': 'Items bought by agent',
    'requestSteps.client.packageShipped': 'Package Shipped',
    'requestSteps.client.packageSentOut': 'Package sent out',
    'requestSteps.client.delivered': 'Delivered',
    'requestSteps.client.orderComplete': 'Order complete',
    ...
    'requestDetails.referenceImages': 'Reference Images',
    'requestDetails.image': 'Image',
    'requestDetails.details': 'Details',
    'requestDetails.location': 'Location',
    'requestDetails.datePosted': 'Date Posted',
    'requestDetails.category': 'Category',
    'requestDetails.deliveryMethod': 'Delivery Method',
    'requestDetails.deliverPersonally': 'Deliver Personally',
    'requestDetails.inPerson': 'In Person',
    'requestDetails.shipToMe': 'Ship to Me',
    'requestDetails.shipping': 'Shipping',
    'requestDetails.budget': 'Budget',
    'requestDetails.shoppingAgent': 'Shopping Agent',
    'requestDetails.orders': 'Orders',
    'requestDetails.verified': 'Verified',
    'requestDetails.progressStatus': 'Progress Status',
    'requestDetails.stepOf': 'Step {current} of {total}',
    'requestDetails.shoppingProgress': 'Shopping Progress',
    'requestDetails.itemsPurchased': 'Items Purchased',
    'requestDetails.specificRequirements': 'Specific Requirements',
    'requestDetails.contactAgent': 'Contact Agent',
    'requestDetails.viewOffers': 'View Offers',
    'requestDetails.cancelRequest': 'Cancel Request',
    'requestDetails.arbitrationCentre': 'Arbitration Centre',
    'requestDetails.offerDetails': 'Offer Details',
    'requestDetails.client': 'Client',
    'requestDetails.memberSince': 'Member since',
    'requestDetails.packageShipped': 'Package Shipped',
    'requestDetails.viewFeedback': 'View Feedback',
    'requestDetails.leaveFeedback': 'Leave Feedback',
    'requestDetails.contactClient': 'Contact Client',

    // Offers
    'offers.agentOffers': 'Agent Offers',
    ...
    'feedback.rateYour': 'Rate your',
    'feedback.overallRating': 'Overall Rating',
    'feedback.selectRating': 'Select Rating',
    ...
    'businessVerification.soleProprietorship': 'Sole Proprietorship',
    'businessVerification.nonProfit': 'Non-Profit',
    'businessVerification.numberOfEmployees': 'Number of Employees',
    'businessVerification.selectRange': 'Select range',
    'businessVerification.employees1to10': '1-10 employees',
    'businessVerification.employees11to50': '11-50 employees',
    ...
    'bank.placeholders.selectCurrency': 'Select currency',
    'bank.bankName': 'Bank Name',
    'bank.placeholders.bankName': 'Enter your bank name',
    'bank.accountType': 'Account Type',
    'bank.placeholders.selectAccountType': 'Select account type',
    'bank.checkingAccount': 'Checking Account',
    'bank.savingsAccount': 'Savings Account',
    'bank.accountNumber': 'Account Number',
    'bank.placeholders.accountNumber': 'Enter your account number',
    'bank.routingNumber': 'Routing Number',
    'bank.placeholders.routingNumber': 'Enter routing number',
    'bank.bankAddress': 'Bank Address',
    'bank.streetAddress': 'Street Address',
    'bank.placeholders.streetAddress': 'Enter street address',
    'bank.city': 'City',
    'bank.placeholders.city': 'Enter city',
    'bank.stateProvince': 'State/Province',
    'bank.placeholders.stateProvince': 'Enter state or province',
    ...
    'currencies.sgd': 'SGD - Singapore Dollar',
    'currencies.hkd': 'HKD - Hong Kong Dollar',
    'currencies.krw': 'KRW - Korean Won',
    ...
    'about.milestone2023Founded': 'Platform Founded',
    'about.milestone2023Launch': 'Beta Launch',
    'about.milestone2024Users': '10K+ Users',
    'about.milestone2024Security': 'Enhanced Security',
    ...
    'support.lastNamePlaceholder': 'Enter your last name',
    'support.emailAddress': 'Email Address',
    'support.emailPlaceholder': 'Enter your email address',
    'support.subject': 'Subject',
    'support.subjectGeneral': 'General Inquiry',
    'support.subjectTechnical': 'Technical Issue',
    'support.subjectAccount': 'Account Issue',
    ...
    'biometricAuth.title': 'Biometric Authentication',
    'biometricAuth.enableBiometric': 'Enable Biometric Authentication',
    'biometricAuth.enableDescription': 'Use your fingerprint or face recognition for secure authentication',
    'biometricAuth.faceIdTitle': 'Face ID',
    'biometricAuth.faceIdDescription': 'Use your face to unlock the app and authenticate transactions',
    'biometricAuth.touchIdTitle': 'Touch ID',
    'biometricAuth.touchIdDescription': 'Use your fingerprint to unlock the app and authenticate transactions',
    'biometricAuth.deviceSecurityTitle': 'Device Security',
    'biometricAuth.deviceSecurityDescription': 'Your biometric data is stored securely on your device and never shared',
    'biometricAuth.securityNoticeTitle': 'Security & Privacy',
    'biometricAuth.securityPoint1': 'Biometric data never leaves your device',
    'biometricAuth.securityPoint2': 'Authentication happens locally on your device',
    'biometricAuth.securityPoint3': 'You can disable biometric authentication at any time',
    'biometricAuth.securityPoint4': 'Your password remains your primary security method',
    'biometricAuth.biometricActive': 'Biometric Authentication Active',
    'biometricAuth.biometricActiveDescription': 'You can now use your biometric authentication for secure access',
  },
  ...
  'zh-cn': {
    ...
    'common.searchInCategory': '在{category}中搜索',
    'common.itemsFound': '找到 {count} 个商品',
    'common.noResults': '未找到结果',
    'common.noItemsFound': '未找到商品',
    'common.noItemsInCategory': '此类别中未找到商品',
    'common.searchOffers': '搜索报价...',
    'common.offersFound': '找到 {count} 个报价',
    'common.searchRequests': '搜索请求...',
    ...
    'search.sortPriceLow': '价格：从低到高',
    'search.sortPriceHigh': '价格：从高到低',
    'search.sortPopular': '最受欢迎',
    'search.tryDifferentTerms': '尝试不同的搜索词',

    // Categories
    'categories.all': '所有类别',
    'categories.food': '食品',
    'categories.home': '家居园艺',
    'categories.sports': '运动健身',
    'categories.books': '图书教育',

    // Explore
    'explore.allOffers': '所有报价',
    'explore.allRequests': '所有请求',

    // Wishlist
    'wishlist.myWishlist': '我的心愿单',
    'wishlist.items': '个商品',
    'wishlist.searchWishlist': '搜索心愿单...',
    ...
    // Create Request
    'createRequest.budgetRangeDescription': '设置您的预算范围，帮助代理了解您的价格期望',
    ...
    'allAgents.subtitle': '浏览所有可用的购物代理',
    'allAgents.searchPlaceholder': '搜索代理...',
    'allAgents.specialty': '专业领域',
    'allAgents.allSpecialties': '所有专业',
    'allAgents.technologyShopping': '科技产品购物',
    'allAgents.fashionLuxury': '时尚奢侈品',
    'allAgents.beautySkincare': '美容护肤',
    'allAgents.electronicsTech': '电子科技',
    'allAgents.homeAppliances': '家居电器',
    'allAgents.gaming': '游戏',
    'allAgents.luxuryWatches': '奢侈手表',
    'allAgents.allLocations': '所有地区',
    'allAgents.northAmerica': '北美',
    'allAgents.europe': '欧洲',
    'allAgents.asia': '亚洲',
    'allAgents.highestRated': '评分最高',
    'allAgents.mostReviews': '评价最多',
    'allAgents.mostOrders': '订单最多',
    'allAgents.fastestResponse': '响应最快',
    'allAgents.highestSuccessRate': '成功率最高',
    'allAgents.agents': '代理',
    'allAgents.found': '找到',
    'allAgents.ordersCompleted': '完成订单',
    'allAgents.successRate': '成功率',
    'allAgents.responds': '响应时间',
    'allAgents.avgDelivery': '平均配送',
    'allAgents.joined': '加入时间',
    'allAgents.languages': '语言',
    'allAgents.contactAgent': '联系代理',
    ...
    'preferences.completeSetup': '完成设置',
    'preferences.selectAtLeastOne': '请至少选择一个类别',

    // Preferences Categories
    'preferences.categories.beauty': '美容护膚',
    'preferences.categories.home': '家具家居',
    'preferences.categories.food': '食品',
    'preferences.categories.electronics': '电子产品',
    'preferences.categories.toys': '玩具游戏',
    'preferences.categories.stationery': '文具办公',
    'preferences.categories.fashion': '时尚服装',
    'preferences.categories.sports': '运动健身',
    'preferences.categories.accessories': '配饰',
    'preferences.categories.bags': '箱包',
    'preferences.categories.automotive': '汽车用品',
    ...
    'auth.demoMode': '演示模式',
    'auth.demoModeDescription': '使用演示数据探索应用',
    'auth.resendCodeIn': '重新发送验证码',
    'auth.verify': '验证',
    ...
    'auth.sendVerificationCode': '发���验证码',
    'auth.createAccount': '创建账户',
    'auth.joinPlatform': '加入我们的平台',
    'auth.profilePicture': '头像',
    'auth.name': '姓名',
    'auth.nickname': '昵称',
    'auth.gender': '性别',
    'auth.male': '男',
    ...
    // Explore
    'explore.title': '探索',
    'explore.description': '发现购物请求、报价和代理商',
    'explore.categories': '类别',
    'explore.requests': '请求',
    'explore.offers': '报价',
    'explore.agents': '代理商',
    'explore.featuredCategories': '热门类别',
    'explore.popularCategories': '热门类别',
    'explore.recentRequests': '最新请求',
    'explore.topOffers': '热门报价',
    'explore.topShoppingOffers': '热门购物报价',
    'explore.topAgents': '顶级代理商',
    'explore.topRatedAgents': '顶级评分代理商',
    'explore.requestsForYou': '为您推荐的请求',
    'explore.searchPlaceholder': '搜索商品、品牌或地点...',
    ...
    'orders.packageShipped': '包裹已发货',
    'orders.shoppingAgent': '购物代理：',
    'orders.client': '客户：',
    'orders.details': '详情',
    'orders.viewFeedback': '查看反馈',
    'orders.leaveFeedback': '留下反馈',
    'orders.contactAgent': '联系代理',
    'orders.viewOffers': '查看报价',
    'orders.contactClient': '联系客户',
    'orders.request': '请求',
    'orders.offer': '报价',
    'orders.stepOf': '第 {current} 步，共 {total} 步',

    // Order Status
    'orders.status.active': '进行中',
    'orders.status.inProgress': '处理中',
    'orders.status.itemsPurchased': '商品已购买',
    'orders.status.purchased': '已购买',
    'orders.status.packageShipped': '包裹已发货',
    'orders.status.completed': '已完成',
    'orders.status.cancelled': '已取消',

    // Order Steps - Client View
    'orders.steps.requestPosted': '请求已发布',
    'orders.steps.waitingForAgents': '等待购物代理提交报价',
    'orders.steps.agentAssigned': '代理已分配',
    'orders.steps.shoppingInProgress': '购物进行中',
    'orders.steps.itemsPurchased': '商品已购买',
    'orders.steps.itemsBoughtByAgent': '代理已购买商品',
    'orders.steps.packageShipped': '包裹已发货',
    'orders.steps.packageSentOut': '包裹已寄出',
    'orders.steps.delivered': '已送达',
    'orders.steps.orderComplete': '订单完成',

    // Order Steps - Agent View
    'orders.steps.requestAccepted': '请求已接受',
    'orders.steps.startingShopping': '开始购物流程',
    'orders.steps.shoppingStarted': '购物已开始',
    'orders.steps.findingRequestedItems': '寻找所需商品',
    'orders.steps.itemsBoughtSuccessfully': '商品购买成功',
    'orders.steps.packageSentToClient': '包裹已发送给客户',
    'orders.steps.successfullyCompleted': '成功完成',

    // Messages
    'messages.title': '消息',
    'messages.description': '与代理商和客户聊天',
    'messages.noMessages': '暂无消息',
    'messages.startChat': '开始对话',
    'messages.signInPrompt': '请登录查看您的消息',
    'messages.signInDescription': '访问您与代理商和客户的对话。',
    'messages.searchChats': '搜索聊天',
    'messages.searchPlaceholder': '搜索对话...',
    'messages.online': '在线',
    'messages.offline': '离线',
    'messages.lastSeen': '最后在线',
    'messages.ago': '前',
    'messages.now': '现在',
    'messages.minuteAgo': '1分钟前',
    'messages.minutesAgo': '{count}分钟前',
    'messages.hourAgo': '1小时前',
    'messages.hoursAgo': '{count}小时前',
    'messages.dayAgo': '1天前',
    'messages.daysAgo': '{count}天前',
    'messages.weekAgo': '1周前',
    'messages.weeksAgo': '{count}周前',
    'messages.monthAgo': '1个月前',
    'messages.monthsAgo': '{count}个月前',
    'messages.typing': '正在输入...',
    'messages.typingIndicator': '{name}正在输入...',
    'messages.messageDelivered': '已送达',
    'messages.messageRead': '已读',
    'messages.messageSent': '已发送',
    'messages.messageSending': '发送中...',
    'messages.messageTypeHere': '输入消息...',
    'messages.sendMessage': '发送消息',
    'messages.attachFile': '附件',
    'messages.attachImage': '图片',
    'messages.attachLocation': '位置',
    'messages.attachDocument': '文档',
    'messages.photoMessage': '图片',
    'messages.locationMessage': '位置',
    'messages.documentMessage': '文档',
    'messages.newConversation': '新对话',
    'messages.conversationWith': '与{name}的对话',
    'messages.requestTitle': '请求：{title}',

    // Profile
    'profile.signIn': '登录',
    'profile.appSettings': '应用设置',
    'profile.translation': '语言',
    'profile.selectLanguage': '选择语言',
    'profile.languageDescription': '选择您偏好的应用界面语言',
    'profile.english': 'English',
    'profile.simplifiedChinese': '简体中文',
    ...
    'profile.transactionPassword': '交易密码',
    'profile.transactionPasswordEnabled': '为支付提供额外安全保障',
    'profile.transactionPasswordDisabled': '未设置',
    'profile.biometricAuth': '生物识别验证',
    'profile.biometricAuthEnabled': '使用指纹或面部识别',
    'profile.biometricAuthDisabled': '未设置',
    'profile.enabled': '已启用',
    'profile.securitySettings': '安全设置',
    'profile.changePassword': '更改密码',
    'profile.twoFactor': '双重验证',
    'profile.signOut': '登出',
    ...
    'profile.terms': '服务条款',
    'profile.signInPrompt': '登录您的账户',
    'profile.signInDescription': '访问您的订单、消息和个性化推荐。',

    // Transaction Password
    'transactionPassword.title': '交易密码',
    'transactionPassword.enableTitle': '启用交易密码',
    'transactionPassword.enableDescription': '为支付和敏感交易添加额外的安全保护。',
    'transactionPassword.enabled': '已启用',
    'transactionPassword.disabled': '已禁用',
    'transactionPassword.updatePassword': '更新密码',
    'transactionPassword.setPassword': '设置密码',
    'transactionPassword.currentPassword': '当前密码',
    'transactionPassword.enterCurrentPassword': '输入您的当前密码',
    'transactionPassword.newPassword': '新密码',
    'transactionPassword.password': '密码',
    'transactionPassword.enterNewPassword': '输入您的新密码',
    'transactionPassword.confirmPassword': '确认密码',
    'transactionPassword.confirmNewPassword': '确认您的新密码',
    'transactionPassword.currentPasswordRequired': '请输入当前密码',
    'transactionPassword.newPasswordRequired': '请输入新密码',
    'transactionPassword.confirmPasswordRequired': '请确认您的密码',
    'transactionPassword.passwordTooShort': '密码至少需要6个字符',
    'transactionPassword.passwordsDoNotMatch': '密码不匹配',
    'transactionPassword.requirements': '密码要求',
    'transactionPassword.requirementLength': '至少6个字符',
    'transactionPassword.requirementMatch': '密码匹配',
    'transactionPassword.infoTitle': '什么是交易密码？',
    'transactionPassword.infoDescription': '交易密码为支付和敏感操作提供额外的安全保护。它与您的登录密码不同，有助于保护您的金融交易。',

    // Biometric Authentication
    'biometricAuth.title': '生物识别验证',
    'biometricAuth.enableBiometric': '启用生物识别验证',
    'biometricAuth.enableDescription': '使用指纹或面部识别进行安全验证',
    'biometricAuth.faceIdTitle': '面部识别',
    'biometricAuth.faceIdDescription': '使用面部识别解锁应用程序和验证交易',
    'biometricAuth.touchIdTitle': '指纹识别',
    'biometricAuth.touchIdDescription': '使用指纹解锁应用程序和验证交易',
    'biometricAuth.deviceSecurityTitle': '设备安全',
    'biometricAuth.deviceSecurityDescription': '您的生物识别数据安全存储在设备上，永不共享',
    'biometricAuth.securityNoticeTitle': '安全和隐私',
    'biometricAuth.securityPoint1': '生物识别数据永不离开您的设备',
    'biometricAuth.securityPoint2': '验证在您的设备上本地进行',
    'biometricAuth.securityPoint3': '您可以随时禁用生物识别验证',
    'biometricAuth.securityPoint4': '您的密码仍是主要的安全方法',
    'biometricAuth.biometricActive': '生物识别验证已激活',
    'biometricAuth.biometricActiveDescription': '您现在可以使用生物识别验证进行安全访问',

    // Edit Profile
    'editProfile.title': '编辑个人资料',
    'editProfile.description': '更新您的个人信息和偏好设置',
    'editProfile.firstName': '名',
    'editProfile.firstNamePlaceholder': '输入您的名',
    'editProfile.lastName': '姓',
    'editProfile.lastNamePlaceholder': '输入您的姓',
    'editProfile.nickname': '昵称',
    'editProfile.nicknamePlaceholder': '输入您的昵称',
    'editProfile.gender': '性别',
    'editProfile.male': '男',
    'editProfile.female': '女',
    'editProfile.other': '其他',
    'editProfile.email': '电子邮箱',
    'editProfile.emailPlaceholder': '输入您的电子邮箱地址',
    'editProfile.phone': '手机号码',
    'editProfile.phonePlaceholder': '输入您的手机号码',
    'editProfile.country': '国家',
    'editProfile.selectCountry': '选择您的国家',
    'editProfile.bio': '个人简介',
    'editProfile.bioPlaceholder': '介绍一下您自己',
    'editProfile.languages': '语言',
    'editProfile.selectLanguages': '选择您使用的语言',
    'editProfile.languagesHelp': '选择您可以交流的语言��最多5种）',
    'editProfile.saving': '保存中...',

    // Create
    'create.title': '创建',
    'create.description': '创建新的购物请求或报价',
    'create.newRequest': '新请求',
    'create.newOffer': '新报价',
    'create.request': '请求',
    'create.offer': '报价',
    'create.creatingRequest': '创建请求',
    'create.creatingOffer': '创建报价',
    ...
    'messages.startProxyShoppingRequest': '开始代购请求以联系代理商',
    'messages.activeNow': '现在活跃',
    'messages.activeMinutesAgo': '{count}分钟前活跃',
    'messages.activeHoursAgo': '{count}小时前活跃',
    'messages.activeDaysAgo': '{count}天前活跃',
    'messages.today': '今天',
    ...
    'createRequest.descriptionPlaceholder': '详细说明您需要的物品...',
    ...
    'createRequest.budgetMinPlaceholder': '最低金额',
    'createRequest.budgetMaxPlaceholder': '最高金额',
    'createRequest.locationInfo': '位置信息',
    'createRequest.productOrigin': '产品产地',
    'createRequest.productOriginPlaceholder': '产品应该从哪里购买？',
    'createRequest.purchasingLocation': '指定购买地点',
    'createRequest.purchasingLocationPlaceholder': '具体商店或地点',
    'createRequest.deliveryLocation': '预期交付地点',
    'createRequest.deliveryLocationPlaceholder': '应该送到哪里？',
    'createRequest.deliveryMethod': '配送方式',
    'createRequest.shipToMe': '邮寄给我',
    'createRequest.deliverPersonally': '亲自交付',
    'createRequest.shippingInformation': '邮寄信息',
    'createRequest.fullName': '姓名',
    'createRequest.fullNamePlaceholder': '输入收件人姓名',
    'createRequest.addressLine1': '地址行1',
    'createRequest.addressLine1Placeholder': '街道地址',
    'createRequest.addressLine2': '地址行2',
    'createRequest.addressLine2Placeholder': '公寓、套房等（可选）',
    'createRequest.city': '城市',
    'createRequest.cityPlaceholder': '输入城市',
    'createRequest.state': '州/省',
    'createRequest.statePlaceholder': '输入州或省',
    'createRequest.postalCode': '邮政编码',
    'createRequest.postalCodePlaceholder': '输入邮政编码',
    'createRequest.country': '国家',
    'createRequest.selectCountry': '选择国家',
    ...
    'createOffer.serviceFee': '服务费',
    'createOffer.serviceFeeType': '费用类型',
    'createOffer.fixedRate': '固定费率',
    'createOffer.percentage': '百分比',
    'createOffer.feeAmount': '费用金额',
    'createOffer.feeAmountPlaceholder': '输入金额',
    'createOffer.feePercentage': '费用百分比',
    'createOffer.feePercentagePlaceholder': '输入百分比',
    'createOffer.minimumOrder': '最低订单金额',
    'createOffer.minimumOrderPlaceholder': '最低订单金额',
    'createOffer.estimatedTime': '预计时间',
    'createOffer.estimatedTimePlaceholder': '例如：3-5个工作日',
    'createOffer.additionalServices': '附加服务',
    'createOffer.qualityCheck': '质量检查',
    'createOffer.qualityCheckDescription': '购买前检查物品',
    'createOffer.photoVerification': '照片验证',
    'createOffer.photoVerificationDescription': '购买前发送物品照片',
    'createOffer.giftWrapping': '礼品包装',
    'createOffer.giftWrappingDescription': '提供礼品包装服务',
    'createOffer.fastDelivery': '快速配送',
    ...
    'categories.beautyDescription': '化妆品、护肤品、香水和美容产品',
    ...
    // Request Steps - Client View
    'requestSteps.client.requestPosted': '请求已发布',
    'requestSteps.client.waitingForAgents': '等待购物代理提交报价',
    'requestSteps.client.agentAssigned': '代理已分配',
    'requestSteps.client.shoppingInProgress': '购物进行中',
    'requestSteps.client.itemsPurchased': '商品已购买',
    'requestSteps.client.itemsBoughtByAgent': '代理已购买商品',
    'requestSteps.client.packageShipped': '包裹已发货',
    'requestSteps.client.packageSentOut': '包裹已寄出',
    'requestSteps.client.delivered': '已送达',
    'requestSteps.client.orderComplete': '订单完成',

    // Request Steps - Agent View
    'requestSteps.agent.requestAccepted': '请求已接受',
    'requestSteps.agent.startingShopping': '开始购物流程',
    'requestSteps.agent.shoppingStarted': '购物已开始',
    'requestSteps.agent.findingItems': '寻找所需商品',
    'requestSteps.agent.itemsPurchased': '商品已购买',
    'requestSteps.agent.itemsBoughtSuccessfully': '商品购买成功',
    'requestSteps.agent.packageShipped': '包裹已发货',
    'requestSteps.agent.packageSentToClient': '包裹已发送给客户',
    'requestSteps.agent.delivered': '已送达',
    'requestSteps.agent.successfullyCompleted': '成功完成',

    // Request Details
    'requestDetails.title': '请求详情',
    'requestDetails.referenceImages': '参考图片',
    'requestDetails.image': '图片',
    'requestDetails.details': '详情',
    'requestDetails.location': '地点',
    'requestDetails.datePosted': '发布日期',
    'requestDetails.category': '类别',
    'requestDetails.deliveryMethod': '配送方式',
    'requestDetails.deliverPersonally': '亲自配送',
    'requestDetails.inPerson': '面对面',
    'requestDetails.shipToMe': '邮寄给我',
    'requestDetails.shipping': '邮寄',
    'requestDetails.budget': '预算',
    'requestDetails.shoppingAgent': '购物代理',
    'requestDetails.orders': '订单',
    'requestDetails.verified': '已验证',
    'requestDetails.progressStatus': '进度状态',
    'requestDetails.stepOf': '第 {current} 步，共 {total} 步',
    'requestDetails.shoppingProgress': '购物进度',
    'requestDetails.itemsPurchased': '商品已购买',
    'requestDetails.specificRequirements': '具体要求',
    'requestDetails.contactAgent': '联系代理',
    'requestDetails.viewOffers': '查看报价',
    'requestDetails.cancelRequest': '取消请求',
    'requestDetails.arbitrationCentre': '仲裁中心',
    'requestDetails.offerDetails': '报价详情',
    'requestDetails.client': '客户',
    'requestDetails.memberSince': '注册时间',
    'requestDetails.packageShipped': '包裹已发货',
    'requestDetails.viewFeedback': '查看反馈',
    'requestDetails.leaveFeedback': '留下反馈',
    'requestDetails.contactClient': '联系客户',

    // Offers
    'offers.agentOffers': '代理报价',
    'offers.agentsHave': '位代理已',
    'offers.offeredToHelp': '提供帮助',
    'offers.acceptOffer': '接受报价',
    'offers.acceptOfferConfirmation': '您确定要接受这个报价吗？',

    // Agent
    'agent.totalOrders': '总订单数',
    'agent.completed': '已完成',
    'agent.respondsIn': '回复时间',
    'agent.reviews': '评价',
    ...
    // Feedback
    'feedback.title': '反馈',
    'feedback.subtitle': '分享您的体验',
    'feedback.rateYour': '评价您的',
    'feedback.overallRating': '整体评价',
    'feedback.selectRating': '选择评价',
    'feedback.yourComments': '您的评论',
    'feedback.shareDetails': '分享您的体验详情',
    'feedback.commentPlaceholder': '告诉我们您的体验...',
    'feedback.feedbackHelps': '您的反馈有助于改善我们的平台',
    'feedback.guidelines': '反馈指导原则',
    'feedback.guideline1': '请诚实并提出建设性意见',
    'feedback.guideline2': '提供具体详情',
    'feedback.guideline3': '保持反馈专业性',
    'feedback.guideline4': '帮助他人做出明智决定',
    'feedback.submitFeedback': '提交反馈',
    'feedback.selectRatingToContinue': '请选择评价以继续',
    'feedback.skipForNow': '暂时跳过',
    'feedback.ratingFair': '一般',
    'feedback.outOfStars': '满分5星',
    'feedback.ratingPoor': '差',
    ...
    'businessVerification.selectBusinessType': '选择您的企业类型',
    'businessVerification.corporation': '股份有限公司',
    'businessVerification.llc': '有限责任公司',
    'businessVerification.partnership': '合伙企业',
    'businessVerification.soleProprietorship': '个人独资企业',
    'businessVerification.nonProfit': '非营利组织',
    'businessVerification.numberOfEmployees': '员工人数',
    'businessVerification.selectRange': '选择范围',
    'businessVerification.employees1to10': '1-10名员工',
    'businessVerification.employees11to50': '11-50名员工',
    'businessVerification.employees51to200': '51-200名员工',
    ...
    'document.passportDescription': '带有照片和个人信息的有效护照',
    'document.driversLicense': '驾驶执照',
    'document.driversLicenseDescription': '带有照片的有效驾驶执照',
    'document.nationalId': '身份证',
    'document.nationalIdDescription': '政府颁发的国民身份证',
    'document.militaryId': '军官证',
    'document.militaryIdDescription': '军人身份证或退伍军人证',

    // Security
    'security.dataSecure': '您的数据是安全的',
    'security.encrypted': '所有信息都经过加密',
    'security.noStorage': '我们不存储敏感文档',
    'security.essentialOnly': '只收集必要的数据',
    'security.deleteAnytime': '随时删除您的数据',

    // Bank Information
    'bank.title': '银行信息',
    'bank.addBankInfo': '添加银行信息',
    'bank.description': '添加您的银行账户信息以进行付款和转账。',
    'bank.fullName': '全名',
    'bank.placeholders.fullName': '输入账户持有人的全名',
    'bank.country': '国家',
    'bank.placeholders.selectCountry': '选择您的国家',
    'bank.currency': '货币',
    'bank.placeholders.selectCurrency': '选择货币',
    'bank.bankName': '银行名称',
    'bank.placeholders.bankName': '输入您的银行名称',
    'bank.accountType': '账户类型',
    'bank.placeholders.selectAccountType': '选择账户类型',
    'bank.checkingAccount': '支票账户',
    'bank.savingsAccount': '储蓄账户',
    'bank.accountNumber': '账户号码',
    'bank.placeholders.accountNumber': '输入您的账户号码',
    'bank.routingNumber': '路由号码',
    'bank.placeholders.routingNumber': '输入路由号码',
    'bank.bankAddress': '银行地址',
    'bank.streetAddress': '街道地址',
    'bank.placeholders.streetAddress': '输入街道地址',
    'bank.city': '城市',
    'bank.placeholders.city': '输入城市',
    'bank.stateProvince': '省/州',
    'bank.placeholders.stateProvince': '输入省或州',
    'bank.zipCode': '邮政编码',
    ...
    'countries.southKorea': '韩国',

    // Currencies
    'currencies.usd': 'USD - 美元',
    'currencies.eur': 'EUR - 欧元',
    'currencies.gbp': 'GBP - 英镑',
    'currencies.jpy': 'JPY - 日元',
    'currencies.cad': 'CAD - 加拿大元',
    'currencies.aud': 'AUD - 澳元',
    'currencies.sgd': 'SGD - 新加坡元',
    'currencies.hkd': 'HKD - 港币',
    'currencies.krw': 'KRW - 韩元',

    // Credit Cards
    'creditCards.title': '信用卡',
    'creditCards.subtitle': '付款方式',
    'creditCards.description': '管理您的信用卡和付款方式。',
    'creditCards.addNewCard': '添加新卡',
    'creditCards.noCards': '尚未添加信用卡',
    'creditCards.confirmDelete': '删除卡片',
    'creditCards.confirmDeleteMessage': '您确定要删除这张信用卡吗？',
    'creditCards.deleteCard': '删除卡片',
    'creditCards.saveChanges': '保存更改',

    // Add Credit Card
    'addCreditCard.paymentSecurity': '付款安全',
    'addCreditCard.security1': '您的付款信息经过加密并且安全',
    'addCreditCard.security2': '我们使用行业标准安全措施',
    'addCreditCard.security3': '您的卡片详情从不存储在我们的服务器上',
    ...
    'changePassword.updatePassword': '更新您的密码',
    'changePassword.requirements': '密码要求',
    'changePassword.currentPassword': '当前密码',
    'changePassword.enterCurrentPassword': '输入您的当前密码',
    'changePassword.newPassword': '新密码',
    'changePassword.enterNewPassword': '输入您的新密码',
    'changePassword.confirmNewPassword': '确认新密码',
    'changePassword.passwordRequirements': '密码必须满足以下要求：',
    'changePassword.requirement1': '至少8个字符',
    'changePassword.requirement2': '包含大写和小写字母',
    'changePassword.requirement3': '包含至少一个数字或特殊字符',
    'changePassword.changeButton': '更改密码',
    ...
    'about.step3Description': '选择最佳报价并确认您的选择。',
    'about.step4Title': '获得配送',
    'about.step4Description': '跟踪您的订单并安全收到您的物品。',
    'about.ourJourney': '我们的历程',
    'about.byTheNumbers': '数据统计',
    'about.activeUsers': '活跃用户',
    'about.countries': '服务国家',
    'about.milestone2023Founded': '平台成立',
    'about.milestone2023Launch': '测试版发布',
    'about.milestone2024Users': '10K+ 用户',
    'about.milestone2024Security': '增强安全性',
    ...
    'terms.prohibited2': '违反任何国际、联邦、省或州��法规、规则、法律或地方条例',
    ...
    'privacy.yourRightsContent': '您有权访���、更新或删除您的个人信息。您也可以选择不接收我们的某些通信。',
    ...
    'support.emailSupportDescription': '通过邮件获得详细回复',
    'support.emailSupportAction': '发送邮件',
    'support.liveChat': '在线客服',
    'support.liveChatDescription': '与我们的支持团队实时聊天',
    'support.liveChatAction': '开始聊天',
    'support.phoneSupport': '电话支持',
    'support.phoneSupportDescription': '致电我们获得即时帮助',
    'support.phoneSupportAction': '立即致电',
    'support.firstName': '名',
    'support.firstNamePlaceholder': '请输入您的名字',
    'support.lastName': '姓',
    'support.lastNamePlaceholder': '请输入您的姓氏',
    'support.emailAddress': '邮箱地址',
    'support.emailPlaceholder': '请输入您的邮箱地址',
    'support.subject': '主题',
    'support.subjectGeneral': '一般咨询',
    'support.subjectTechnical': '技术问题',
    'support.subjectAccount': '账户问题',
    'support.subjectBilling': '计费问题',
    'support.subjectFeature': '功能请求',
    'support.message': '消息',
    'support.messagePlaceholder': '请详细描述您的问题或疑问...',
    'support.sendMessage': '发送消息',
    'support.commonQuestions': '常见问题',
    'support.helpfulResources': '有用资源',
    'support.userGuide': '用户指南',
    'support.userGuideDescription': '使用我们平台的完整指南',
    'support.videoTutorials': '视频教程',
    'support.videoTutorialsDescription': '逐步视频指导',
    ...
    'preferences.categories.food': '食品',
    'preferences.categories.electronics': '电子产品',
    'preferences.categories.toys': '玩具玩偶',
    'preferences.categories.stationery': '文具用品',
    'preferences.categories.fashion': '时尚服饰',
    'preferences.categories.sports': '运动健身',
    'preferences.categories.accessories': '手表珠宝',
    ...
    'createOffer.domesticShippingDescription': '国内配送',
    'createOffer.international': '国际配送',
    'createOffer.internationalDescription': '全球配送',
    ...
    'createRequest.deliverPersonally': '亲自配送',
    'createRequest.deliverPersonallyDescription': '面对面配送',
    'createRequest.personalDeliveryNote': '代理将与您面对面交付商品',
    ...
    'createRequest.state': '州/省',
    'createRequest.statePlaceholder': '州/省',
    'createRequest.postalCode': '邮政编码',
    'createRequest.postalCodePlaceholder': '邮政/邮编',
    'createRequest.country': '国家',
    'createRequest.selectCountry': '选择国家',
    'createRequest.attachments': '附件',
    'createRequest.uploadDescription': '上传图片、文档或规格说明',
    'createRequest.chooseFiles': '选择文件',
  },
  ...
  'zh-tw': {
    ...
    'common.noItemsFound': '未找到商品',
    'common.noItemsInCategory': '此類別中未找到商品',
    'common.searchOffers': '搜尋報價...',
    'common.offersFound': '找到 {count} 個報價',
    'common.searchRequests': '搜尋請求...',
    ...
    // Search
    'search.sortNewest': '最新',
    'search.sortPriceLow': '價格：從低到高',
    'search.sortPriceHigh': '價格：從高到低',
    'search.sortPopular': '最受歡迎',
    'search.tryDifferentTerms': '嘗試不同的搜尋詞',

    // Categories
    'categories.all': '所有類別',
    'categories.food': '食品',
    'categories.home': '居家園藝',
    'categories.sports': '運動健身',
    'categories.books': '圖書教育',

    // Explore
    'explore.allOffers': '所有報價',
    'explore.allRequests': '所有請求',

    // Wishlist
    'wishlist.myWishlist': '我的願望清單',
    'wishlist.items': '個商品',
    'wishlist.searchWishlist': '搜尋願望清單...',
    ...
    // Create Request
    'createRequest.budgetRangeDescription': '設置您的預算範圍，幫助代理了解您的價格期望',
    ...
    // All Agents Page
    'allAgents.title': '所有代理',
    'allAgents.subtitle': '瀏覽所有可用的購物代理',
    'allAgents.searchPlaceholder': '搜尋代理...',
    'allAgents.specialty': '專業領域',
    'allAgents.allSpecialties': '所有專業',
    'allAgents.technologyShopping': '科技產品購物',
    'allAgents.fashionLuxury': '時尚奢侈品',
    'allAgents.beautySkincare': '美容護膚',
    'allAgents.electronicsTech': '電子科技',
    'allAgents.homeAppliances': '家居電器',
    'allAgents.gaming': '遊戲',
    'allAgents.luxuryWatches': '奢侈手錶',
    'allAgents.allLocations': '所有地區',
    'allAgents.northAmerica': '北美',
    'allAgents.europe': '歐洲',
    'allAgents.asia': '亞洲',
    'allAgents.highestRated': '評分最高',
    'allAgents.mostReviews': '評價最多',
    'allAgents.mostOrders': '訂單最多',
    'allAgents.fastestResponse': '響應最快',
    'allAgents.highestSuccessRate': '成功率最高',
    'allAgents.agents': '代理',
    'allAgents.found': '找到',
    'allAgents.ordersCompleted': '完成訂單',
    'allAgents.successRate': '成功率',
    'allAgents.responds': '響應時間',
    'allAgents.avgDelivery': '平均配送',
    'allAgents.joined': '加入時間',
    'allAgents.languages': '語言',
    'allAgents.contactAgent': '聯繫代理',
    ...
    'preferences.completeSetup': '完成���置',
    ...
    'preferences.categories.home': '家具家居',
    'preferences.categories.food': '食品',
    'preferences.categories.electronics': '電子產品',
    'preferences.categories.toys': '玩具遊戲',
    'preferences.categories.stationery': '文具辦公',
    'preferences.categories.fashion': '時尚服裝',
    'preferences.categories.sports': '運動健身',
    'preferences.categories.accessories': '配飾',
    'preferences.categories.bags': '箱包',
    'preferences.categories.automotive': '汽車用品',
    'preferences.categories.others': '其他',
    ...
    'auth.orSignInWith': '或使用以下方式登入',
    'auth.dontHaveAccount': '還沒有帳戶？',
    'auth.verifyCode': '驗證碼',
    'auth.verificationCodeSent': '驗證碼已發送',
    'auth.demoMode': '演示模式',
    'auth.demoModeDescription': '使用演示資料探索應用程式',
    'auth.resendCodeIn': '重新發送驗證碼',
    'auth.verify': '驗證',
    ...
    'auth.sendVerificationCode': '發送驗證碼',
    'auth.createAccount': '建立帳戶',
    'auth.joinPlatform': '加入我們的平台',
    'auth.profilePicture': '個人頭像',
    'auth.name': '姓名',
    'auth.nickname': '暱稱',
    'auth.gender': '性別',
    'auth.male': '男性',
    ...
    'auth.country': '國家',
    'auth.bio': '個人簡介',
    'auth.tellUsAboutYourself': '介紹一下您自己',
    'auth.confirmPassword': '確認密碼',
    'auth.agreeWith': '我同意',
    'auth.termsConditions': '條款與條件',
    'auth.orSignUpWith': '或使用以下方式註冊',
    'auth.alreadyHaveAccount': '已經有帳戶？',

    // Explore
    'explore.title': '探索',
    'explore.description': '發現購物請求、報價和代理商',
    'explore.categories': '類別',
    'explore.requests': '請求',
    'explore.offers': '報價',
    'explore.agents': '代理商',
    'explore.featuredCategories': '熱門類別',
    'explore.popularCategories': '熱門類別',
    'explore.recentRequests': '最新請求',
    'explore.topOffers': '熱門報價',
    'explore.topShoppingOffers': '熱門購物報價',
    'explore.topAgents': '頂級代理商',
    'explore.topRatedAgents': '頂級評分代理商',
    'explore.requestsForYou': '為您推薦的請求',
    'explore.searchPlaceholder': '搜尋商品、品牌或地點...',
    'explore.viewAll': '查看全部',
    ...
    'orders.packageShipped': '包裹已發貨',
    'orders.shoppingAgent': '購物代理：',
    'orders.client': '客戶：',
    'orders.details': '詳情',
    'orders.viewFeedback': '查看反饋',
    'orders.leaveFeedback': '留下反饋',
    'orders.contactAgent': '聯繫代理',
    'orders.viewOffers': '查看報價',
    'orders.contactClient': '聯繫客戶',
    'orders.request': '請求',
    'orders.offer': '報價',
    'orders.stepOf': '第 {current} 步，共 {total} 步',
    ...
    'orders.status.inProgress': '處理中',
    'orders.status.itemsPurchased': '商品已購買',
    'orders.status.purchased': '已購買',
    'orders.status.packageShipped': '包裹已發貨',
    'orders.status.completed': '已完成',
    'orders.status.cancelled': '已取消',

    // Order Steps - Client View
    'orders.steps.requestPosted': '請求已發布',
    'orders.steps.waitingForAgents': '等待購物代理提交報價',
    'orders.steps.agentAssigned': '代理已分配',
    'orders.steps.shoppingInProgress': '購物進行中',
    'orders.steps.itemsPurchased': '商品已購買',
    'orders.steps.itemsBoughtByAgent': '代理已購買商品',
    'orders.steps.packageShipped': '包裹已發貨',
    'orders.steps.packageSentOut': '包裹已寄出',
    'orders.steps.delivered': '已送達',
    'orders.steps.orderComplete': '訂單完成',

    // Order Steps - Agent View
    'orders.steps.requestAccepted': '請求已接受',
    'orders.steps.startingShopping': '開始購物流程',
    'orders.steps.shoppingStarted': '購物已開始',
    'orders.steps.findingRequestedItems': '尋找所需商品',
    'orders.steps.itemsBoughtSuccessfully': '商品購買成功',
    'orders.steps.packageSentToClient': '包裹已發送給���戶',
    'orders.steps.successfullyCompleted': '成功完成',

    // Messages
    'messages.title': '訊息',
    'messages.description': '與代理商和客戶聊天',
    'messages.noMessages': '暫無訊息',
    'messages.startChat': '開始對話',
    'messages.signInPrompt': '請登入查看您的訊息',
    'messages.signInDescription': '存取您與代理商和客戶的對話。',
    'messages.searchChats': '搜尋聊天',
    'messages.searchPlaceholder': '搜尋對話...',
    'messages.online': '線上',
    'messages.offline': '離線',
    'messages.lastSeen': '最後上線',
    'messages.ago': '前',
    'messages.now': '現在',
    'messages.minuteAgo': '1分鐘前',
    'messages.minutesAgo': '{count}分鐘前',
    'messages.hourAgo': '1小時前',
    'messages.hoursAgo': '{count}小時前',
    'messages.dayAgo': '1天前',
    'messages.daysAgo': '{count}天前',
    'messages.weekAgo': '1週前',
    'messages.weeksAgo': '{count}週前',
    'messages.monthAgo': '1個月前',
    'messages.monthsAgo': '{count}個月前',
    'messages.typing': '正在輸入...',
    'messages.typingIndicator': '{name}正在輸入...',
    'messages.messageDelivered': '已送達',
    'messages.messageRead': '已讀',
    'messages.messageSent': '已發送',
    'messages.messageSending': '發送中...',
    'messages.messageTypeHere': '輸入訊息...',
    'messages.sendMessage': '發送訊息',
    'messages.attachFile': '附件',
    'messages.attachImage': '圖片',
    'messages.attachLocation': '位置',
    'messages.attachDocument': '文件',
    'messages.photoMessage': '圖片',
    'messages.locationMessage': '位置',
    'messages.documentMessage': '文件',
    'messages.newConversation': '新對話',
    'messages.conversationWith': '與{name}的對話',
    'messages.requestTitle': '請求：{title}',

    // Profile
    'profile.signIn': '登錄',
    'profile.appSettings': '應用程式設定',
    'profile.translation': '語言',
    'profile.selectLanguage': '選擇語言',
    'profile.languageDescription': '選擇您偏好的應用程式介面語言',
    'profile.english': 'English',
    'profile.simplifiedChinese': '简体中文',
    'profile.traditionalChinese': '繁體中文',
    'profile.japanese': '日本語',
    ...
    'profile.creditCards': '信用卡',
    'profile.transactionPassword': '交易密碼',
    'profile.transactionPasswordEnabled': '為付款提供額外安全保障',
    'profile.transactionPasswordDisabled': '未設定',
    'profile.biometricAuth': '生物識別驗證',
    'profile.biometricAuthEnabled': '使用指紋或面部識別',
    'profile.biometricAuthDisabled': '未設定',
    'profile.enabled': '已啟用',
    'profile.securitySettings': '安全設定',
    'profile.changePassword': '更改密碼',
    'profile.twoFactor': '雙重驗證',
    'profile.signOut': '登出',
    'profile.helpSupport': '幫助與支援',
    'profile.helpCenter': '幫助中心',
    'profile.aboutUs': '關於我們',
    'profile.privacy': '隱私政策',
    'profile.terms': '服務條款',
    'profile.signInPrompt': '登入您的帳戶',
    'profile.signInDescription': '存取您的訂單、訊息和個人化推薦。',

    // Transaction Password
    'transactionPassword.title': '交易密碼',
    'transactionPassword.enableTitle': '啟用交易密碼',
    'transactionPassword.enableDescription': '為付款和敏感交易添加額外的安全保護。',
    'transactionPassword.enabled': '已啟用',
    'transactionPassword.disabled': '已停用',
    'transactionPassword.updatePassword': '更新密碼',
    'transactionPassword.setPassword': '設定密碼',
    'transactionPassword.currentPassword': '目前密碼',
    'transactionPassword.enterCurrentPassword': '輸入您的目前密碼',
    'transactionPassword.newPassword': '新密碼',
    'transactionPassword.password': '密碼',
    'transactionPassword.enterNewPassword': '輸入您的新密碼',
    'transactionPassword.confirmPassword': '確認密碼',
    'transactionPassword.confirmNewPassword': '確認您的新密碼',
    'transactionPassword.currentPasswordRequired': '請輸入目前密碼',
    'transactionPassword.newPasswordRequired': '請輸入新密碼',
    'transactionPassword.confirmPasswordRequired': '請確認您的密碼',
    'transactionPassword.passwordTooShort': '密碼至少需要6個字元',
    'transactionPassword.passwordsDoNotMatch': '密碼不匹配',
    'transactionPassword.requirements': '密碼要求',
    'transactionPassword.requirementLength': '至少6個字元',
    'transactionPassword.requirementMatch': '密碼匹配',
    'transactionPassword.infoTitle': '什麼是交易密碼？',
    'transactionPassword.infoDescription': '交易密碼為付款和敏感操作提供額外的安全保護。它與您的登入密碼不同，有助於保護您的金融交易。',

    // Biometric Authentication
    'biometricAuth.title': '生物識別驗證',
    'biometricAuth.enableBiometric': '啟用生物識別驗證',
    'biometricAuth.enableDescription': '使用指紋或面部識別進行安全驗證',
    'biometricAuth.faceIdTitle': '面部識別',
    'biometricAuth.faceIdDescription': '使用面部識別解鎖應用程式和驗證交易',
    'biometricAuth.touchIdTitle': '指紋識別',
    'biometricAuth.touchIdDescription': '使用指紋解鎖應用程式和驗證交易',
    'biometricAuth.deviceSecurityTitle': '設備安全',
    'biometricAuth.deviceSecurityDescription': '您的生物識別數據安全存儲在您的設備上，絕不共享',
    'biometricAuth.securityNoticeTitle': '安全和隱私',
    'biometricAuth.securityPoint1': '生物識別數據絕不離開您的設備',
    'biometricAuth.securityPoint2': '驗證在您的設備上本地進行',
    'biometricAuth.securityPoint3': '您可以隨時禁用生物識別驗證',
    'biometricAuth.securityPoint4': '您的密碼仍是主要的安全方法',
    'biometricAuth.biometricActive': '生物識別驗證已啟用',
    'biometricAuth.biometricActiveDescription': '您現在可以使用生物識別驗證進行安全訪問',

    // Edit Profile
    'editProfile.title': '編輯個人資料',
    'editProfile.description': '更新您的個人資訊和偏好設定',
    'editProfile.firstName': '名字',
    'editProfile.firstNamePlaceholder': '輸入您的名字',
    'editProfile.lastName': '姓氏',
    'editProfile.lastNamePlaceholder': '輸入您的姓氏',
    'editProfile.nickname': '暱稱',
    'editProfile.nicknamePlaceholder': '輸入您的暱稱',
    'editProfile.gender': '性別',
    'editProfile.male': '男性',
    'editProfile.female': '女性',
    'editProfile.other': '其他',
    'editProfile.email': '電子郵件',
    'editProfile.emailPlaceholder': '輸入您的電子郵件地址',
    'editProfile.phone': '手機號碼',
    'editProfile.phonePlaceholder': '輸入您的手機號碼',
    'editProfile.country': '國家',
    'editProfile.selectCountry': '選擇您的國家',
    'editProfile.bio': '個人簡介',
    'editProfile.bioPlaceholder': '介紹一下您自己',
    'editProfile.saving': '保存中...',

    // Create
    'create.title': '創建',
    'create.description': '創建新的購物請求或報價',
    'create.newRequest': '新請求',
    'create.newOffer': '新報價',
    'create.request': '請求',
    'create.offer': '報價',
    'create.creatingRequest': '創建請求',
    'create.creatingOffer': '創建報價',
    ...
    'createRequest.description': '描述',
    'createRequest.descriptionPlaceholder': '詳細說明您需要的物品...',
    ...
    'createRequest.budgetMinPlaceholder': '最低金額',
    'createRequest.budgetMaxPlaceholder': '最高金額',
    'createRequest.locationInfo': '位置資訊',
    'createRequest.productOrigin': '產品產地',
    'createRequest.productOriginPlaceholder': '產品應該從哪裡購買？',
    'createRequest.purchasingLocation': '指定購買地點',
    'createRequest.purchasingLocationPlaceholder': '具體商店或地點',
    'createRequest.deliveryLocation': '預期交付地點',
    'createRequest.deliveryLocationPlaceholder': '應該送到哪裡？',
    'createRequest.deliveryMethod': '配送方式',
    'createRequest.shipToMe': '郵寄給我',
    'createRequest.deliverPersonally': '親自交付',
    'createRequest.shippingInformation': '郵寄資訊',
    'createRequest.fullName': '姓名',
    'createRequest.fullNamePlaceholder': '輸入收件人姓名',
    'createRequest.addressLine1': '地址行1',
    'createRequest.addressLine1Placeholder': '街道地址',
    'createRequest.addressLine2': '地址行2',
    'createRequest.addressLine2Placeholder': '公寓、套房等（可選）',
    'createRequest.city': '城市',
    'createRequest.cityPlaceholder': '輸入城市',
    'createRequest.state': '州/省',
    'createRequest.statePlaceholder': '輸入州或省',
    'createRequest.postalCode': '郵政編碼',
    'createRequest.postalCodePlaceholder': '輸入郵政編碼',
    'createRequest.country': '國家',
    ...
    'createOffer.serviceFee': '服務費',
    'createOffer.serviceFeeType': '費用類型',
    'createOffer.fixedRate': '固定費率',
    'createOffer.percentage': '百分比',
    'createOffer.feeAmount': '費用金額',
    'createOffer.feeAmountPlaceholder': '輸入金額',
    'createOffer.feePercentage': '費用百分比',
    'createOffer.feePercentagePlaceholder': '輸入百分比',
    'createOffer.minimumOrder': '最低訂單金額',
    'createOffer.minimumOrderPlaceholder': '最低訂單金額',
    'createOffer.estimatedTime': '預計時間',
    'createOffer.estimatedTimePlaceholder': '例如：3-5個工作日',
    'createOffer.additionalServices': '附加服務',
    'createOffer.qualityCheck': '品質檢查',
    'createOffer.qualityCheckDescription': '購買前檢查物品',
    'createOffer.photoVerification': '照片驗證',
    'createOffer.photoVerificationDescription': '購買前發送物品照片',
    'createOffer.giftWrapping': '禮品包裝',
    'createOffer.giftWrappingDescription': '提供禮品包裝服務',
    'createOffer.fastDelivery': '快速配送',
    ...
    'categories.beauty': '美容',
    'categories.beautyDescription': '化妝品、護膚品、香水和美容產品',
    ...
    'recommendations.forYou': '為您推薦',
    'recommendations.loadMore': '載入更多',

    // Request Steps - Client View
    'requestSteps.client.requestPosted': '請求已發布',
    'requestSteps.client.waitingForAgents': '等待購物代理提交報價',
    'requestSteps.client.agentAssigned': '代理已分配',
    'requestSteps.client.shoppingInProgress': '購物進行中',
    'requestSteps.client.itemsPurchased': '商品已購買',
    'requestSteps.client.itemsBoughtByAgent': '代理已購買商品',
    'requestSteps.client.packageShipped': '包裹已發貨',
    'requestSteps.client.packageSentOut': '包裹已寄出',
    'requestSteps.client.delivered': '已送達',
    'requestSteps.client.orderComplete': '訂單完成',

    // Request Steps - Agent View
    'requestSteps.agent.requestAccepted': '請求已接受',
    'requestSteps.agent.startingShopping': '開始購物流程',
    'requestSteps.agent.shoppingStarted': '購物已開始',
    'requestSteps.agent.findingItems': '尋找所需商品',
    'requestSteps.agent.itemsPurchased': '商品已購買',
    'requestSteps.agent.itemsBoughtSuccessfully': '商品購買成功',
    'requestSteps.agent.packageShipped': '包裹已發貨',
    'requestSteps.agent.packageSentToClient': '包裹已發送給客戶',
    'requestSteps.agent.delivered': '已送達',
    'requestSteps.agent.successfullyCompleted': '成功完成',

    // Request Details
    'requestDetails.title': '請求詳情',
    'requestDetails.referenceImages': '參考圖片',
    'requestDetails.image': '圖片',
    'requestDetails.details': '詳情',
    'requestDetails.location': '地點',
    'requestDetails.datePosted': '發布日期',
    'requestDetails.category': '類別',
    'requestDetails.deliveryMethod': '配送方式',
    'requestDetails.deliverPersonally': '親自配送',
    'requestDetails.inPerson': '面對面',
    'requestDetails.shipToMe': '郵寄給我',
    'requestDetails.shipping': '郵寄',
    'requestDetails.budget': '預算',
    'requestDetails.shoppingAgent': '購物代理',
    'requestDetails.orders': '訂單',
    'requestDetails.verified': '已驗證',
    'requestDetails.progressStatus': '進度狀態',
    'requestDetails.stepOf': '第 {current} 步，共 {total} 步',
    'requestDetails.shoppingProgress': '購物進度',
    'requestDetails.itemsPurchased': '商品已購買',
    'requestDetails.specificRequirements': '具體要求',
    'requestDetails.contactAgent': '聯繫代理',
    'requestDetails.viewOffers': '查看報價',
    'requestDetails.cancelRequest': '取消請求',
    'requestDetails.arbitrationCentre': '仲裁中心',
    'requestDetails.offerDetails': '報價詳情',
    'requestDetails.client': '客戶',
    'requestDetails.memberSince': '註冊時間',
    'requestDetails.packageShipped': '包裹已發貨',
    'requestDetails.viewFeedback': '查看反饋',
    'requestDetails.leaveFeedback': '留下反饋',
    'requestDetails.contactClient': '聯繫客戶',

    // Offers
    'offers.agentOffers': '代理報價',
    'offers.agentsHave': '位代理已',
    'offers.offeredToHelp': '提供幫助',
    'offers.acceptOffer': '接受報價',
    'offers.acceptOfferConfirmation': '您確定要接受這個報價嗎？',

    // Agent
    'agent.totalOrders': '總訂單數',
    'agent.completed': '已完成',
    'agent.respondsIn': '回覆時間',
    'agent.reviews': '評價',
    ...
    // Feedback
    'feedback.title': '回饋',
    'feedback.subtitle': '分享您的體驗',
    'feedback.rateYour': '評價您的',
    'feedback.overallRating': '整體評價',
    'feedback.selectRating': '選擇評價',
    'feedback.yourComments': '您的評論',
    'feedback.shareDetails': '分享您的體驗詳情',
    'feedback.commentPlaceholder': '告訴我們您的體驗...',
    'feedback.feedbackHelps': '您的回饋有助於改善我們的平台',
    'feedback.guidelines': '回饋指導原則',
    'feedback.guideline1': '請誠實並提出建設性意見',
    'feedback.guideline2': '提供具體詳情',
    'feedback.guideline3': '保持回饋專業性',
    'feedback.guideline4': '幫助他人做出明智決定',
    'feedback.submitFeedback': '提交回饋',
    'feedback.selectRatingToContinue': '請選擇評價以繼續',
    'feedback.skipForNow': '暫時跳過',
    'feedback.ratingFair': '普通',
    'feedback.outOfStars': '滿分5星',
    'feedback.ratingPoor': '差',
    ...
    'businessVerification.selectBusinessType': '選擇您的企業類型',
    'businessVerification.corporation': '股份有限公司',
    'businessVerification.llc': '有限責任公司',
    'businessVerification.partnership': '合夥企業',
    'businessVerification.soleProprietorship': '個人獨資企業',
    'businessVerification.nonProfit': '非營利組織',
    'businessVerification.numberOfEmployees': '員工人數',
    'businessVerification.selectRange': '選擇範圍',
    'businessVerification.employees1to10': '1-10名員工',
    'businessVerification.employees11to50': '11-50名員工',
    'businessVerification.employees51to200': '51-200名員工',
    ...
    'document.passportDescription': '帶有照片和個人資訊的有效護照',
    'document.driversLicense': '駕駛執照',
    'document.driversLicenseDescription': '帶有照片的有效駕駛執照',
    'document.nationalId': '身份證',
    'document.nationalIdDescription': '政府頒發的國民身份證',
    'document.militaryId': '軍官證',
    'document.militaryIdDescription': '軍人身份證或退伍軍人證',

    // Security
    'security.dataSecure': '您的資料是安全的',
    'security.encrypted': '所有資訊都經過加密',
    'security.noStorage': '我們不存儲敏感文件',
    'security.essentialOnly': '只收集必要的資料',
    'security.deleteAnytime': '隨時刪除您的資料',

    // Bank Information
    'bank.title': '銀行資訊',
    'bank.addBankInfo': '新增銀行資訊',
    'bank.description': '新增您的銀行帳戶資訊以進行付款和轉帳。',
    'bank.fullName': '全名',
    'bank.placeholders.fullName': '輸入帳戶持有人的全名',
    'bank.country': '國家',
    'bank.placeholders.selectCountry': '選擇您的國家',
    'bank.currency': '貨幣',
    'bank.placeholders.selectCurrency': '選擇貨幣',
    'bank.bankName': '銀行名稱',
    'bank.placeholders.bankName': '輸入您的銀行名稱',
    'bank.accountType': '帳戶類型',
    'bank.placeholders.selectAccountType': '選擇帳戶類型',
    'bank.checkingAccount': '支票帳戶',
    'bank.savingsAccount': '儲蓄帳戶',
    'bank.accountNumber': '帳戶號碼',
    'bank.placeholders.accountNumber': '輸入您的帳戶號碼',
    'bank.routingNumber': '路由號碼',
    'bank.placeholders.routingNumber': '輸入路由號碼',
    'bank.bankAddress': '銀行地址',
    'bank.streetAddress': '街道地址',
    'bank.placeholders.streetAddress': '輸入街道地址',
    'bank.city': '城市',
    'bank.placeholders.city': '輸入城市',
    'bank.stateProvince': '省/州',
    'bank.placeholders.stateProvince': '輸入省或州',
    'bank.zipCode': '郵政編碼',
    ...
    'countries.singapore': '新加坡',
    'countries.hongKong': '香港',
    'countries.southKorea': '韓國',

    // Currencies
    'currencies.usd': 'USD - 美元',
    'currencies.eur': 'EUR - 歐元',
    'currencies.gbp': 'GBP - 英鎊',
    'currencies.jpy': 'JPY - 日圓',
    'currencies.cad': 'CAD - 加幣',
    'currencies.aud': 'AUD - 澳幣',
    'currencies.sgd': 'SGD - 新加坡幣',
    'currencies.hkd': 'HKD - 港幣',
    'currencies.krw': 'KRW - 韓元',

    // Credit Cards
    'creditCards.title': '信用卡',
    'creditCards.subtitle': '付款方式',
    'creditCards.description': '管理您的信用卡和付款方式。',
    'creditCards.addNewCard': '新增卡片',
    'creditCards.noCards': '尚未新增信用卡',
    'creditCards.confirmDelete': '刪除卡片',
    'creditCards.confirmDeleteMessage': '您確定要刪除這張信用卡嗎？',
    'creditCards.deleteCard': '刪除卡片',
    'creditCards.saveChanges': '保存更改',

    // Add Credit Card
    'addCreditCard.paymentSecurity': '付款安全',
    'addCreditCard.security1': '您的付款資訊經過加密並且安全',
    'addCreditCard.security2': '我們使用行業標準安全措施',
    'addCreditCard.security3': '您的卡片詳情從不存儲在我們的伺服器上',
    ...
    'changePassword.updatePassword': '更新您的密碼',
    'changePassword.requirements': '密碼要求',
    'changePassword.currentPassword': '目前密碼',
    'changePassword.enterCurrentPassword': '輸入您的目前密碼',
    'changePassword.newPassword': '新密碼',
    'changePassword.enterNewPassword': '輸入您的新密碼',
    'changePassword.confirmNewPassword': '確認新密碼',
    'changePassword.passwordRequirements': '密碼必須滿足以下要求：',
    'changePassword.requirement1': '至少8個字元',
    'changePassword.requirement2': '包含大寫和小寫字母',
    'changePassword.requirement3': '包含至少一個數字或特殊字元',
    'changePassword.changeButton': '更改密碼',
    ...
    'about.step3Description': '選擇最佳報價並確認您的選擇。',
    'about.step4Title': '獲得配送',
    'about.step4Description': '追蹤您的訂單並安全收到您的物品。',
    'about.ourJourney': '我們的歷程',
    'about.byTheNumbers': '數據統計',
    'about.activeUsers': '活躍用戶',
    'about.countries': '服務國家',
    'about.milestone2023Founded': '平台成立',
    'about.milestone2023Launch': '測試版發布',
    'about.milestone2024Users': '10K+ 用戶',
    'about.milestone2024Security': '增強安全性',
    ...
    'support.emailSupportDescription': '透過電子郵件獲得詳細回覆',
    'support.emailSupportAction': '發送郵件',
    ...
    'support.firstName': '名',
    'support.firstNamePlaceholder': '請輸入您的名字',
    'support.lastName': '姓',
    'support.lastNamePlaceholder': '請輸入您的姓氏',
    'support.emailAddress': '電子郵件地址',
    'support.emailPlaceholder': '請輸入您的電子郵件地址',
    'support.subject': '主題',
    'support.subjectGeneral': '一般詢問',
    'support.subjectTechnical': '技術問題',
    'support.subjectAccount': '帳戶問題',
    'support.subjectBilling': '計費問題',
    'support.subjectFeature': '功能請求',
    'support.message': '訊息',
    'support.messagePlaceholder': '請詳細描述您的問題或疑問...',
    'support.sendMessage': '發送訊息',
    'support.commonQuestions': '常見問題',
    'support.helpfulResources': '有用資源',
    'support.userGuide': '使用者指南',
    'support.userGuideDescription': '使用我們平台的完整指南',
    'support.videoTutorials': '影片教學',
    'support.videoTutorialsDescription': '逐步影片指導',
    ...
    'preferences.categories.toys': '玩具玩偶',
    'preferences.categories.stationery': '文具用品',
    'preferences.categories.fashion': '時尚服飾',
    'preferences.categories.sports': '運動健身',
    'preferences.categories.accessories': '手錶珠寶',
    'preferences.categories.bags': '包包手袋',
    ...
    'createOffer.domesticShippingDescription': '國內配送',
    'createOffer.international': '國際配送',
    'createOffer.internationalDescription': '全球配送',
    ...
    'createRequest.shipToMeDescription': '包裹配送',
    'createRequest.deliverPersonally': '親自配送',
    'createRequest.deliverPersonallyDescription': '面對面配送',
    'createRequest.personalDeliveryNote': '代理將與您面對面交付商品',
    ...
    'createRequest.statePlaceholder': '州/省',
    'createRequest.postalCode': '郵政編碼',
    'createRequest.postalCodePlaceholder': '郵政/郵編',
    'createRequest.country': '國家',
    'createRequest.selectCountry': '選擇國家',
    'createRequest.attachments': '附件',
    'createRequest.uploadDescription': '上傳圖片、文件或規格說明',
    'createRequest.chooseFiles': '選擇檔案',
  },
  ...
  ja: {
    ...
    'common.of': '/',
    'common.complete': '完了',
    'common.stepOf': 'ステップ {current}/{total}',
    'common.searchInCategory': '{category}で検索',
    'common.itemsFound': '{count}件の商品が見つかりました',
    'common.noResults': '結果が見つかりません',
    'common.noItemsFound': '商品が見つかりません',
    'common.noItemsInCategory': 'このカテゴリに商品が見つかりません',
    'common.searchOffers': 'オファーを検索...',
    'common.offersFound': '{count}件のオファーが見つかりました',
    'common.searchRequests': 'リクエストを検索...',
    ...
    // Search
    'search.sortNewest': '最新',
    'search.sortPriceLow': '価格：安い順',
    'search.sortPriceHigh': '価格：高い順',
    'search.sortPopular': '人気順',
    'search.tryDifferentTerms': '他の検索語句を試してください',

    // Categories
    'categories.all': 'すべてのカテゴリ',
    'categories.food': 'フード',
    'categories.home': 'ホーム・ガーデン',
    'categories.sports': 'スポーツ・フィットネス',
    'categories.books': '書籍・教育',

    // Explore
    'explore.allOffers': 'すべてのオファー',
    'explore.allRequests': 'すべてのリクエスト',

    // Wishlist
    'wishlist.myWishlist': 'マイウィッシュリスト',
    'wishlist.items': '件',
    'wishlist.searchWishlist': 'ウィッシュリストを検索...',
    ...
    'messages.chatFeaturesDescription': 'エージェントやクライアントと直接コミュニケーション',
    'messages.agentBadge': 'エージェント',
    'messages.today': '今日',
    'messages.messageAgentPlaceholder': 'エージェントにメッセージを入力...',

    // Create Request
    'createRequest.budgetRangeDescription': '予算範囲を設定して、エージェントに価格の期待値を理解してもらいましょう',
    ...
    'offerDetails.productCostNote': '商品代金はチェックアウト時に追加されます',
    'offerDetails.agentStats': 'エージェント統計',

    // All Agents Page
    'allAgents.title': 'すべてのエージェント',
    'allAgents.subtitle': '利用可能なショッピングエージェントを参照',
    'allAgents.searchPlaceholder': 'エージェントを検索...',
    'allAgents.specialty': '専門分野',
    'allAgents.allSpecialties': 'すべての専門分野',
    'allAgents.technologyShopping': 'テクノロジーショッピング',
    'allAgents.fashionLuxury': 'ファッション・ラグジュアリー',
    'allAgents.beautySkincare': '美容・スキンケア',
    'allAgents.electronicsTech': 'エレクトロニクス・テック',
    'allAgents.homeAppliances': 'ホーム・家電',
    'allAgents.gaming': 'ゲーミング',
    'allAgents.luxuryWatches': '高級時計',
    'allAgents.allLocations': 'すべての地域',
    'allAgents.northAmerica': '北米',
    'allAgents.europe': 'ヨーロッパ',
    'allAgents.asia': 'アジア',
    'allAgents.highestRated': '最高評価',
    'allAgents.mostReviews': 'レビュー数',
    'allAgents.mostOrders': '注文数',
    'allAgents.fastestResponse': '最速応答',
    'allAgents.highestSuccessRate': '最高成功率',
    'allAgents.agents': 'エージェント',
    'allAgents.found': '件見つかりました',
    'allAgents.ordersCompleted': '注文完了',
    'allAgents.successRate': '成功率',
    'allAgents.responds': '応答時間',
    'allAgents.avgDelivery': '平均配送',
    'allAgents.joined': '参加日',
    'allAgents.languages': '言語',
    'allAgents.contactAgent': 'エージェントに連絡',
    ...
    'preferences.categories.home': '家具・ホーム',
    'preferences.categories.food': '食品',
    'preferences.categories.electronics': '電子機器',
    'preferences.categories.toys': 'おもちゃ・ゲーム',
    'preferences.categories.stationery': '文房具・オフィス',
    'preferences.categories.fashion': 'ファッション・衣類',
    'preferences.categories.sports': 'スポーツ・フィットネス',
    'preferences.categories.accessories': 'アクセサリー',
    'preferences.categories.bags': 'バッグ・ラゲッジ',
    'preferences.categories.automotive': '自動車用品',
    'preferences.categories.others': 'その他',
    ...
    'auth.orSignInWith': 'または以下でサインイ���',
    'auth.dontHaveAccount': 'アカウントをお持ちでないですか？',
    'auth.verifyCode': '認証コード',
    'auth.verificationCodeSent': '認証コードを送信しました',
    'auth.demoMode': 'デモモード',
    'auth.demoModeDescription': 'デモデータでアプリを探索',
    'auth.resendCodeIn': 'コード再送信まで',
    'auth.verify': '認証',
    'auth.resendCode': '再送信',
    'auth.email': 'メール��ドレス',
    'auth.password': 'パスワード',
    ...
    'auth.female': '女性',
    'auth.other': 'その他',
    'auth.preferNotToSay': '回答しない',
    'auth.phoneNo': '電話番号',
    'auth.country': '国',
    'auth.bio': '��己紹介',
    'auth.tellUsAboutYourself': '自己紹介をしてください',
    'auth.confirmPassword': '���スワード確認',
    'auth.agreeWith': '同意します',
    'auth.termsConditions': '利用規約',
    'auth.orSignUpWith': 'または以下でサインアップ',
    ...
    'auth.agreeToTerms': '利用規約に同意してください',
    ...
    'explore.offers': 'オファー',
    'explore.agents': 'エージェント',
    'explore.featuredCategories': '注目のカテゴリ',
    'explore.popularCategories': '人気のカテゴリ',
    'explore.recentRequests': '最近のリクエスト',
    'explore.topOffers': 'トップオファー',
    'explore.topShoppingOffers': 'トップショッピングオファー',
    'explore.topAgents': 'トップエージェント',
    'explore.topRatedAgents': 'トップ評価エージェント',
    'explore.requestsForYou': 'あなたへのリクエスト',
    'explore.searchPlaceholder': 'アイテム、ブランド、場所を検索...',
    'explore.viewAll': 'すべて表示',
    ...
    'orders.packageShipped': '配送済み',
    'orders.shoppingAgent': 'ショッピングエージェント：',
    'orders.client': 'クライアント：',
    'orders.details': '詳細',
    'orders.viewFeedback': 'フィードバック表示',
    'orders.leaveFeedback': 'フィードバック投稿',
    'orders.contactAgent': 'エージェントに連絡',
    'orders.viewOffers': 'オファー表示',
    'orders.contactClient': 'クライアントに連絡',
    'orders.request': 'リクエスト',
    'orders.offer': 'オファー',
    'orders.stepOf': 'ステップ {current}/{total}',

    // Order Status
    'orders.status.active': 'アクティブ',
    'orders.status.inProgress': '進行中',
    'orders.status.itemsPurchased': '商品購入済み',
    'orders.status.purchased': '購入済み',
    'orders.status.packageShipped': '配送済み',
    ...
    'orders.steps.itemsBoughtByAgent': 'エージェントが商品を購入',
    'orders.steps.packageShipped': '配送済み',
    'orders.steps.packageSentOut': '荷物発送済み',
    'orders.steps.delivered': '配達済み',
    'orders.steps.orderComplete': '注文完了',
    ...
    'messages.lastSeen': '最終ログイン',
    'messages.ago': '前',
    'messages.now': '今',
    'messages.minuteAgo': '1分前',
    'messages.minutesAgo': '{count}分前',
    'messages.hourAgo': '1時間前',
    'messages.hoursAgo': '{count}時間前',
    'messages.dayAgo': '1日前',
    'messages.daysAgo': '{count}日前',
    'messages.weekAgo': '1週間前',
    'messages.weeksAgo': '{count}週間前',
    'messages.monthAgo': '1ヶ月前',
    'messages.monthsAgo': '{count}ヶ月前',
    'messages.typing': '入力中...',
    'messages.typingIndicator': '{name}が入力中...',
    'messages.messageDelivered': '配信済み',
    'messages.messageRead': '既読',
    'messages.messageSent': '送信済み',
    'messages.messageSending': '送信中...',
    'messages.messageTypeHere': 'メッセージを入力...',
    'messages.sendMessage': 'メッセージを送信',
    'messages.attachFile': 'ファイル添付',
    'messages.attachImage': '画像添付',
    'messages.attachLocation': '位置情報共有',
    'messages.attachDocument': '文書添付',
    'messages.photoMessage': '写真',
    'messages.locationMessage': '位置情報',
    'messages.documentMessage': '文書',
    'messages.newConversation': '新しい会話',
    'messages.conversationWith': '{name}との会話',
    'messages.requestTitle': 'リクエスト：{title}',
    ...
    'profile.transactionPassword': '取引パスワード',
    'profile.transactionPasswordEnabled': '支払いに追加のセキュリティを提供',
    'profile.transactionPasswordDisabled': '設定されていません',
    'profile.biometricAuth': '生体認証',
    'profile.biometricAuthEnabled': '指紋または顔認証を使用',
    'profile.biometricAuthDisabled': '設定されていません',
    'profile.enabled': '有効',
    'profile.securitySettings': 'セキュリティ設定',
    'profile.changePassword': 'パスワード変更',
    'profile.twoFactor': '二段階認証',
    'profile.signOut': 'サインアウト',
    'profile.helpSupport': 'ヘルプ＆サポート',
    'profile.helpCenter': 'ヘルプセンター',
    'profile.aboutUs': '会社概要',
    ...
    // Transaction Password
    'transactionPassword.title': '取引パスワード',
    'transactionPassword.enableTitle': '取引パスワードを有効にする',
    'transactionPassword.enableDescription': '支払いと機密取引に追加のセキュリティレイヤーを追加します。',
    'transactionPassword.enabled': '有効',
    'transactionPassword.disabled': '無効',
    'transactionPassword.updatePassword': 'パスワードを更新',
    'transactionPassword.setPassword': 'パスワードを設定',
    'transactionPassword.currentPassword': '現在のパスワード',
    'transactionPassword.enterCurrentPassword': '現在のパスワードを入力してください',
    'transactionPassword.newPassword': '新しいパスワード',
    'transactionPassword.password': 'パスワード',
    'transactionPassword.enterNewPassword': '新しいパスワードを入力してください',
    'transactionPassword.confirmPassword': 'パスワードの確認',
    'transactionPassword.confirmNewPassword': '新しいパスワードを確認してください',
    'transactionPassword.currentPasswordRequired': '現在のパスワードが必要です',
    'transactionPassword.newPasswordRequired': '新しいパスワードが必要です',
    'transactionPassword.confirmPasswordRequired': 'パスワードの確認が必要です',
    'transactionPassword.passwordTooShort': 'パスワードは6文字以上である必要があります',
    'transactionPassword.passwordsDoNotMatch': 'パスワードが一致しません',
    'transactionPassword.requirements': 'パスワード要件',
    'transactionPassword.requirementLength': '6文字以上',
    'transactionPassword.requirementMatch': 'パスワードが一致',
    'transactionPassword.infoTitle': '取引パスワードとは？',
    'transactionPassword.infoDescription': '取引パスワードは、支払いと機密操作に追加のセキュリティを提供します。ログインパスワードとは異なり、金融取引を保護するのに役立ちます。',

    // Biometric Authentication
    'biometricAuth.title': '生体認証',
    'biometricAuth.enableBiometric': '生体認証を有効にする',
    'biometricAuth.enableDescription': '指紋または顔認証を使用してセキュアな認証を行います',
    'biometricAuth.faceIdTitle': 'Face ID',
    'biometricAuth.faceIdDescription': '顔認証を使用してアプリのロック解除と取引認証を行います',
    'biometricAuth.touchIdTitle': 'Touch ID',
    'biometricAuth.touchIdDescription': '指紋を使用してアプリのロック解除と取引認証を行います',
    'biometricAuth.deviceSecurityTitle': 'デバイスセキュリティ',
    'biometricAuth.deviceSecurityDescription': '生体認証データはデバイス上で安全に保存され、決して共有されません',
    'biometricAuth.securityNoticeTitle': 'セキュリティとプライバシー',
    'biometricAuth.securityPoint1': '生体認証データがデバイスから離れることはありません',
    'biometricAuth.securityPoint2': '認証はデバイス上でローカルに実行されます',
    'biometricAuth.securityPoint3': 'いつでも生体認証を無効にできます',
    'biometricAuth.securityPoint4': 'パスワードは引き続き主要なセキュリティ方法です',
    'biometricAuth.biometricActive': '生体認証がアクティブです',
    'biometricAuth.biometricActiveDescription': 'セキュアなアクセスに生体認証を使用できるようになりました',

    // Edit Profile
    'editProfile.title': 'プロフィール編集',
    'editProfile.description': '個人情報と設定を更新してください',
    'editProfile.firstName': '名',
    'editProfile.firstNamePlaceholder': '名前を入力してください',
    'editProfile.lastName': '姓',
    ...
    'editProfile.selectCountry': '国を選択してください',
    'editProfile.bio': '自���紹介',
    ...
    'create.offer': 'オファー',
    'create.creatingRequest': 'リクエスト作成',
    ...
    'createRequest.addRequirement': '要件を追加',
    'createRequest.requirementPlaceholder': '例：色：黒、サイズ：L',
    'createRequest.budgetRange': '予算範囲',
    'createRequest.budgetMin': '最低予算',
    'createRequest.budgetMax': '最大予算',
    'createRequest.budgetMinPlaceholder': '最低金額',
    ...
    'createRequest.shippingInformation': '配送情報',
    'createRequest.fullName': 'フルネーム',
    'createRequest.fullNamePlaceholder': '受取人名を入力',
    ...
    'createRequest.statePlaceholder': '都道府県を入力',
    'createRequest.postalCode': '郵便番号',
    'createRequest.postalCodePlaceholder': '郵便番号を入力',
    ...
    'createOffer.serviceFee': 'サービス料',
    'createOffer.serviceFeeType': '料金タイプ',
    'createOffer.fixedRate': '固定料金',
    'createOffer.percentage': 'パーセンテージ',
    'createOffer.feeAmount': '料金額',
    'createOffer.feeAmountPlaceholder': '金額を入力',
    'createOffer.feePercentage': '料金パーセンテージ',
    'createOffer.feePercentagePlaceholder': 'パーセンテージを入力',
    'createOffer.minimumOrder': '最小注文金額',
    'createOffer.minimumOrderPlaceholder': '最小注文金額',
    'createOffer.estimatedTime': '予定時間',
    'createOffer.estimatedTimePlaceholder': '例：3-5営業日',
    'createOffer.additionalServices': '追加サービス',
    ...
    'recommendations.forYou': 'あなたへのおすすめ',
    'recommendations.loadMore': 'もっと読み込む',
    ...
    'requestSteps.client.orderComplete': '注文完了',

    // Request Steps - Agent View
    'requestSteps.agent.requestAccepted': 'リクエスト受諾',
    'requestSteps.agent.startingShopping': 'ショッピングプロセス開始',
    'requestSteps.agent.shoppingStarted': 'ショッピング開始',
    'requestSteps.agent.findingItems': 'リクエストされた商品を検索中',
    ...
    // Request Details
    'requestDetails.title': 'リクエスト詳細',
    'requestDetails.referenceImages': '参考画像',
    'requestDetails.image': '画像',
    'requestDetails.details': '詳細',
    'requestDetails.location': '場所',
    'requestDetails.datePosted': '投稿日',
    'requestDetails.category': 'カテゴリ',
    'requestDetails.deliveryMethod': '配送方法',
    'requestDetails.deliverPersonally': '直接配送',
    'requestDetails.inPerson': '対面',
    'requestDetails.shipToMe': '配送',
    'requestDetails.shipping': '配送',
    'requestDetails.budget': '予算',
    'requestDetails.shoppingAgent': 'ショッピングエージェント',
    'requestDetails.orders': '注文',
    'requestDetails.verified': '認証済み',
    'requestDetails.progressStatus': '進捗状況',
    'requestDetails.stepOf': 'ステップ {current}/{total}',
    'requestDetails.shoppingProgress': 'ショッピング進捗',
    'requestDetails.itemsPurchased': '商品購入済み',
    'requestDetails.specificRequirements': '具体的な要件',
    'requestDetails.contactAgent': 'エージェントに連絡',
    'requestDetails.viewOffers': 'オファー表示',
    'requestDetails.cancelRequest': 'リクエストをキャンセル',
    'requestDetails.arbitrationCentre': '仲裁センター',
    'requestDetails.offerDetails': 'オファー詳細',
    'requestDetails.client': 'クライアント',
    'requestDetails.memberSince': '登録日',
    'requestDetails.packageShipped': '荷物発送済み',
    'requestDetails.viewFeedback': 'フィードバックを見る',
    'requestDetails.leaveFeedback': 'フィードバックを残す',
    'requestDetails.contactClient': 'クライアントに連絡',

    // Offers
    'offers.agentOffers': 'エージェントオファー',
    'offers.agentsHave': '人のエージェントが',
    'offers.offeredToHelp': 'サポートを申し出ています',
    'offers.acceptOffer': 'オファーを受諾',
    'offers.acceptOfferConfirmation': 'このオファーを受諾しますか？',

    // Agent
    'agent.totalOrders': '総注文数',
    'agent.completed': '完了',
    'agent.respondsIn': '応答時間',
    'agent.reviews': 'レビュー',
    ...
    'feedback.subtitle': '体験を共有してください',
    'feedback.rateYour': 'あなたの',
    'feedback.overallRating': '総合評価',
    'feedback.selectRating': '評価を選択',
    ...
    'businessVerification.soleProprietorship': '個人事業主',
    'businessVerification.nonProfit': '非営利団体',
    'businessVerification.numberOfEmployees': '従業員��',
    'businessVerification.selectRange': '範囲を選択',
    'businessVerification.employees1to10': '1-10名',
    'businessVerification.employees11to50': '11-50名',
    'businessVerification.employees51to200': '51-200名',
    ...
    'document.militaryIdDescription': '軍人身分証または退役軍人証',

    // Security
    'security.dataSecure': 'お客様のデータは安全です',
    'security.encrypted': 'すべての情報は暗号化されています',
    'security.noStorage': '機密文書は保存いたしません',
    'security.essentialOnly': '必要最小限のデータのみ収集',
    'security.deleteAnytime': 'いつでもデータを削除できます',
    ...
    'bank.country': '国',
    'bank.placeholders.selectCountry': '国を選択してください',
    'bank.currency': '通貨',
    'bank.placeholders.selectCurrency': '通貨を選択',
    'bank.bankName': '銀行名',
    'bank.placeholders.bankName': '銀行名を入力してください',
    'bank.accountType': '口座種別',
    'bank.placeholders.selectAccountType': '口座種別を選択',
    'bank.checkingAccount': '普通預金',
    'bank.savingsAccount': '貯蓄預金',
    'bank.accountNumber': '口座番号',
    'bank.placeholders.accountNumber': '口座番号を入力してください',
    'bank.routingNumber': '支店番号',
    'bank.placeholders.routingNumber': '支店番号を入力してください',
    'bank.bankAddress': '銀行住所',
    'bank.streetAddress': '住所',
    'bank.placeholders.streetAddress': '住所を入力してください',
    'bank.city': '市区町村',
    'bank.placeholders.city': '市区町村を入力してください',
    'bank.stateProvince': '都道府県',
    'bank.placeholders.stateProvince': '都道府県を入力してください',
    'bank.zipCode': '郵便番号',
    'bank.placeholders.zipCode': '郵便番号を入力してください',
    'bank.addressCountry': '国',
    'bank.verificationProcess': '銀行口座の確認に1-2営業日かかる場合があります',
    'bank.securityInfo': 'お客様の銀行情報���暗号化され安全に管理されています',
    'bank.verificationTime': '確認は通常1-2営業日かかります',
    'bank.paymentsInfo': '確認後、この口座で支払いを受け取ることができます',
    'bank.save': '銀行情報を保存',

    // Countries
    'countries.unitedStates': 'アメリカ合衆国',
    'countries.canada': 'カナダ',
    'countries.unitedKingdom': 'イギリス',
    ...
    'countries.hongKong': '香港',
    'countries.southKorea': '韓国',

    // Currencies
    'currencies.usd': 'USD - 米ドル',
    'currencies.eur': 'EUR - ユーロ',
    'currencies.gbp': 'GBP - 英ポンド',
    'currencies.jpy': 'JPY - 日本円',
    'currencies.cad': 'CAD - カナダドル',
    'currencies.aud': 'AUD - 豪ドル',
    'currencies.sgd': 'SGD - シンガポールドル',
    'currencies.hkd': 'HKD - 香港ドル',
    'currencies.krw': 'KRW - 韓国ウォン',
    ...
    'twoFactor.recommendedText': '二段階認証はアカウントセキュリティを大幅���向上させます。',
    ...
    'changePassword.changeButton': 'パスワード変更',
    ...
    'about.countries': 'サービス提供国',
    'about.milestone2023Founded': 'プラットフォーム設立',
    'about.milestone2023Launch': 'ベータ版リリース',
    'about.milestone2024Users': '10K+ ユーザー',
    'about.milestone2024Security': 'セキュリティ強化',
    ...
    'support.lastName': '姓',
    'support.lastNamePlaceholder': 'ご苗字を入力してください',
    'support.emailAddress': 'メールアドレス',
    'support.emailPlaceholder': 'メールアドレスを入力してください',
    'support.subject': '件名',
    'support.subjectGeneral': '一般的なお問い合わせ',
    'support.subjectTechnical': '技術的な問題',
    'support.subjectAccount': 'アカウントの問題',
    ...
    'createOffer.domesticShipping': '国内配送',
    'createOffer.domesticShippingDescription': '国内配送',
    'createOffer.international': '国際配送',
    'createOffer.internationalDescription': '世界配送',
    ...
    'createRequest.state': '都道府県',
    'createRequest.statePlaceholder': '都道府県',
    'createRequest.postalCode': '郵便番号',
    'createRequest.postalCodePlaceholder': '郵便番号',
    'createRequest.country': '国',
    'createRequest.selectCountry': '国を選択',
  ...
  ko: {
    ...
    'common.of': '/',
    'common.complete': '완료',
    'common.stepOf': '{total}단계 중 {current}단계',
    'common.searchInCategory': '{category}에서 검색',
    ...
    'search.sortPriceLow': '가격: 낮은 순',
    'search.sortPriceHigh': '가격: 높은 순',
    'search.sortPopular': '인기순',
    'search.tryDifferentTerms': '다른 검색어를 시도해보세요',

    // Categories
    'categories.all': '모든 카테고리',
    'categories.food': '식품',
    'categories.home': '홈 & 가든',
    'categories.sports': '스포츠 & 피트니스',
    'categories.books': '도서 & 교육',

    // Explore
    'explore.allOffers': '모든 오퍼',
    'explore.allRequests': '모든 요청',

    // Wishlist
    'wishlist.myWishlist': '내 위시리스트',
    'wishlist.items': '개 상품',
    'wishlist.searchWishlist': '위시리스트 검색...',
    ...
    'messages.chatFeaturesDescription': '에이전트와 클라이언트와 직접 소통',
    'messages.agentBadge': '에이전트',
    'messages.today': '오늘',
    'messages.messageAgentPlaceholder': '에이전트에게 메시지 입력...',

    // Create Request
    'createRequest.budgetRangeDescription': '예산 범위를 설정하여 에이전트가 가격 기대치를 이해할 수 있도록 도와주세요',
    ...
    'allAgents.subtitle': '이용 가능한 모든 쇼핑 에이전트 둘러보기',
    'allAgents.searchPlaceholder': '에이전트 검색...',
    'allAgents.specialty': '전문 분야',
    'allAgents.allSpecialties': '모든 전문 분야',
    'allAgents.technologyShopping': '기술 제품 쇼핑',
    'allAgents.fashionLuxury': '패션 & 럭셔리',
    'allAgents.beautySkincare': '뷰티 & 스킨케어',
    'allAgents.electronicsTech': '전자제품 & 기술',
    'allAgents.homeAppliances': '홈 & 가전제품',
    'allAgents.gaming': '게이밍',
    'allAgents.luxuryWatches': '럭셔리 시계',
    'allAgents.allLocations': '모든 지역',
    'allAgents.northAmerica': '북미',
    'allAgents.europe': '유럽',
    'allAgents.asia': '아시아',
    'allAgents.highestRated': '최고 평점',
    'allAgents.mostReviews': '리뷰 많은 순',
    'allAgents.mostOrders': '주문 많은 순',
    'allAgents.fastestResponse': '빠른 응답',
    'allAgents.highestSuccessRate': '높은 성공률',
    'allAgents.agents': '에이전트',
    'allAgents.found': '명 찾음',
    'allAgents.ordersCompleted': '완료된 주문',
    'allAgents.successRate': '성공률',
    'allAgents.responds': '응답 시간',
    'allAgents.avgDelivery': '평균 배송',
    'allAgents.joined': '가입일',
    'allAgents.languages': '언어',
    'allAgents.contactAgent': '에이전트 연락',
    ...
    'preferences.categories.food': '식품',
    'preferences.categories.electronics': '전��제품',
    'preferences.categories.toys': '완구 & 게임',
    'preferences.categories.stationery': '문구 & 사무용품',
    'preferences.categories.fashion': '패션 & 의류',
    'preferences.categories.sports': '스포츠 & 피트니스',
    'preferences.categories.accessories': '액세서리',
    'preferences.categories.bags': '가방 & 러기지',
    'preferences.categories.automotive': '자동차 용품',
    ...
    'auth.dontHaveAccount': '계정이 없나요?',
    'auth.verifyCode': '인증번호',
    'auth.verificationCodeSent': '인증번호가 전송되었습니다',
    'auth.demoMode': '데모 모드',
    'auth.demoModeDescription': '데모 데이터로 앱 탐색',
    'auth.resendCodeIn': '재전송 대기 시간',
    'auth.verify': '인증',
    'auth.resendCode': '재전송',
    'auth.email': '이메일',
    'auth.password': '비밀번호',
    ...
    'auth.sendVerificationCode': '인증번호 전송',
    'auth.createAccount': '계정 만들기',
    'auth.joinPlatform': '플랫폼에 가입하세요',
    'auth.profilePicture': '프로필 사진',
    'auth.name': '이름',
    'auth.nickname': '닉네임',
    'auth.gender': '성별',
    'auth.male': '남성',
    'auth.female': '여성',
    'auth.other': '기타',
    'auth.preferNotToSay': '선택하지 않음',
    'auth.phoneNo': '전화번호',
    'auth.country': '국가',
    'auth.bio': '자기소개',
    'auth.tellUsAboutYourself': '자신에 대해 소개해주세요',
    'auth.confirmPassword': '비밀번호 확인',
    'auth.agreeWith': '동의합니다',
    'auth.termsConditions': '이용약관',
    'auth.orSignUpWith': '또는 다음으로 ���원가입',
    ...
    'auth.agreeToTerms': '이용약관에 동의해 주세요',

    // Explore
    'explore.title': '탐색',
    'explore.description': '쇼핑 요청, 제안, 에이전트 발견하기',
    'explore.categories': '카테고리',
    'explore.requests': '요청',
    'explore.offers': '제안',
    'explore.agents': '에이전트',
    'explore.featuredCategories': '주요 카테고리',
    'explore.popularCategories': '인기 카테고리',
    'explore.recentRequests': '최근 요청',
    'explore.topOffers': '인기 제안',
    'explore.topShoppingOffers': '인기 쇼핑 제안',
    'explore.topAgents': '인기 에이전���',
    'explore.topRatedAgents': '최고 평점 에이전트',
    'explore.requestsForYou': '당신을 위한 요청',
    'explore.searchPlaceholder': '상품, 브랜드, 위치 검색...',
    'explore.viewAll': '모두 보기',
    ...
    'orders.packageShipped': '배송 중',
    'orders.shoppingAgent': '쇼핑 에이전트:',
    'orders.client': '고객:',
    'orders.details': '상세정보',
    'orders.viewFeedback': '피드백 보기',
    'orders.leaveFeedback': '피드백 남기기',
    'orders.contactAgent': '에이전트 연락',
    'orders.viewOffers': '제안 보기',
    'orders.contactClient': '고객 ��락',
    'orders.request': '요청',
    'orders.offer': '제안',
    'orders.stepOf': '{total}단계 중 {current}단계',

    // Order Status
    'orders.status.active': '활성',
    'orders.status.inProgress': '진행 중',
    'orders.status.itemsPurchased': '상품 구매 완료',
    'orders.status.purchased': '구매 완료',
    'orders.status.packageShipped': '배송 중',
    ...
    'orders.steps.itemsBoughtByAgent': '에이전트가 상품 구매함',
    'orders.steps.packageShipped': '배송 중',
    'orders.steps.packageSentOut': '패키지 발송됨',
    'orders.steps.delivered': '배송 완료',
    'orders.steps.orderComplete': '주문 완료',

    // Order Steps - Agent View
    'orders.steps.requestAccepted': '요청 수락됨',
    'orders.steps.startingShopping': '쇼핑 프로세스 시작',
    'orders.steps.shoppingStarted': '쇼핑 시작됨',
    'orders.steps.findingRequestedItems': '요청된 상품 찾는 중',
    'orders.steps.itemsBoughtSuccessfully': '상품 구매 성공',
    'orders.steps.packageSentToClient': '고객에게 패키지 발송',
    'orders.steps.successfullyCompleted': '성공적으로 완료됨',

    // Messages
    'messages.title': '메시지',
    'messages.description': '에이전트 및 고객과 채팅',
    ...
    'messages.activeDaysAgo': '{count}일 전 활성',
    'messages.today': '오늘',
    'messages.yesterday': '어제',
    'messages.online': '온라인',
    'messages.messageAgentPlaceholder': '{name}에게 메시지 보내기...',
    ...
    'profile.transactionPassword': '거래 비밀번호',
    'profile.transactionPasswordEnabled': '결제에 추가 보안 제공',
    'profile.transactionPasswordDisabled': '설정되지 않음',
    'profile.biometricAuth': '생체 인증',
    'profile.biometricAuthEnabled': '지문 또는 얼굴 인식 사용',
    'profile.biometricAuthDisabled': '설정되지 않음',
    ...
    'profile.helpCenter': '도움말 센터',
    'profile.aboutUs': '회사 소개',
    ...
    // Transaction Password
    'transactionPassword.title': '거래 비밀번호',
    'transactionPassword.enableTitle': '거래 비밀번호 활성화',
    'transactionPassword.enableDescription': '결제 및 중요한 거래에 추가 보안 계층을 추가합니다.',
    'transactionPassword.enabled': '활성화됨',
    'transactionPassword.disabled': '비활성화됨',
    'transactionPassword.updatePassword': '비밀번호 업데이트',
    'transactionPassword.setPassword': '비밀번호 설정',
    'transactionPassword.currentPassword': '현재 비밀번호',
    'transactionPassword.enterCurrentPassword': '현재 비밀번호를 입력하세요',
    'transactionPassword.newPassword': '새 비밀번호',
    'transactionPassword.password': '비밀번호',
    'transactionPassword.enterNewPassword': '새 비밀번호를 입력하세요',
    'transactionPassword.confirmPassword': '비밀번호 확인',
    'transactionPassword.confirmNewPassword': '새 비밀번호를 확인하세요',
    'transactionPassword.currentPasswordRequired': '현재 비밀번호가 필요합니다',
    'transactionPassword.newPasswordRequired': '새 비밀번호가 필요합니다',
    'transactionPassword.confirmPasswordRequired': '비밀번호 확인이 필요합니다',
    'transactionPassword.passwordTooShort': '비밀번호는 최소 6자 이상이어야 합니다',
    'transactionPassword.passwordsDoNotMatch': '비밀번호가 일치하지 않습니다',
    'transactionPassword.requirements': '비밀번호 요구사항',
    'transactionPassword.requirementLength': '최소 6자 이상',
    'transactionPassword.requirementMatch': '비밀번호 일치',
    'transactionPassword.infoTitle': '거래 비밀번호란?',
    'transactionPassword.infoDescription': '거래 비밀번호는 결제 및 중요한 작업에 추가 보안을 제공합니다. 로그인 비밀번호와는 다르며 금융 거래를 보호하는 데 도움이 됩니다.',

    // Edit Profile
    'editProfile.title': '프로필 편집',
    'editProfile.description': '개인 정보와 설정을 업데이트하세요',
    'editProfile.firstName': '이름',
    'editProfile.firstNamePlaceholder': '이름을 입력하세요',
    'editProfile.lastName': '성',
    'editProfile.lastNamePlaceholder': '성을 입력하세요',
    'editProfile.nickname': '닉네임',
    'editProfile.nicknamePlaceholder': '닉네임을 입력하세요',
    'editProfile.gender': '성별',
    'editProfile.male': '남성',
    'editProfile.female': '여성',
    'editProfile.other': '기타',
    'editProfile.email': '이메일',
    'editProfile.emailPlaceholder': '이메일 주소를 입력하세요',
    'editProfile.phone': '전화번호',
    'editProfile.phonePlaceholder': '전화번호를 입력하세요',
    'editProfile.country': '국가',
    'editProfile.selectCountry': '국가를 선택하세요',
    ...
    // Create
    'create.title': '생성',
    'create.description': '새로운 쇼핑 요청 또는 제안 생성',
    'create.newRequest': '새 요청',
    'create.newOffer': '새 제안',
    'create.request': '요청',
    'create.offer': '제안',
    'create.creatingRequest': '요청 생성 중...',
    ...
    'createRequest.budgetMin': '최소 금액',
    'createRequest.budgetMax': '최대 금액',
    ...
    'recommendations.forYou': '당신을 위한 추천',
    'recommendations.loadMore': '더 보기',
    ...
    'requestSteps.client.orderComplete': '주문 완료',

    // Request Details
    'requestDetails.title': '요청 상세정보',
    'requestDetails.referenceImages': '참고 이미지',
    'requestDetails.image': '이미지',
    'requestDetails.details': '상세정보',
    'requestDetails.location': '위치',
    'requestDetails.datePosted': '게시 날짜',
    'requestDetails.category': '카테고리',
    'requestDetails.deliveryMethod': '배송 방법',
    'requestDetails.deliverPersonally': '직접 배송',
    'requestDetails.inPerson': '대면',
    'requestDetails.shipToMe': '배송',
    'requestDetails.shipping': '배송',
    'requestDetails.budget': '예산',
    'requestDetails.shoppingAgent': '쇼핑 에이전트',
    'requestDetails.orders': '주문',
    'requestDetails.verified': '인증됨',
    'requestDetails.progressStatus': '진행 상태',
    'requestDetails.stepOf': '{total}단계 중 {current}단계',
    'requestDetails.shoppingProgress': '쇼핑 진행 상황',
    'requestDetails.itemsPurchased': '상품 구매 완료',
    'requestDetails.specificRequirements': '구체적인 요구사항',
    'requestDetails.contactAgent': '에이전트 연락',
    'requestDetails.viewOffers': '제안 보기',
    'requestDetails.cancelRequest': '요청 취소',
    'requestDetails.arbitrationCentre': '중재 센터',

    // Offers
    'offers.agentOffers': '에이전트 제안',
    'offers.agentsHave': '명의 에이전트가',
    'offers.offeredToHelp': '도움을 제안했습니다',
    'offers.acceptOffer': '제안 수락',
    'offers.acceptOfferConfirmation': '이 제안을 수락하시겠습니까?',

    // Agent
    'agent.totalOrders': '총 주문 수',
    'agent.completed': '완료',
    'agent.respondsIn': '응답 시간',
    'agent.reviews': '리뷰',
    ...
    // Feedback
    'feedback.title': '피드백',
    'feedback.subtitle': '경험을 공유해주세요',
    'feedback.rateYour': '평가하기',
    'feedback.overallRating': '전체 평가',
    'feedback.selectRating': '평가 선택',
    ...
    'businessVerification.soleProprietorship': '개인사업자',
    'businessVerification.nonProfit': '비영리단체',
    'businessVerification.numberOfEmployees': '직원 수',
    'businessVerification.selectRange': '범위 선택',
    'businessVerification.employees1to10': '1-10명',
    'businessVerification.employees11to50': '11-50명',
    'businessVerification.employees51to200': '51-200명',
    ...
    'document.militaryIdDescription': '군인신분증 또는 보훈증',

    // Security
    'security.dataSecure': '귀하의 데이터는 안전합니다',
    'security.encrypted': '모든 정보는 암호화됩니다',
    'security.noStorage': '민감한 문서는 저장하지 않습니다',
    'security.essentialOnly': '필수 데이터만 수집합니다',
    'security.deleteAnytime': '언제든지 데이터를 삭제할 수 있습니다',
    ...
    'bank.country': '국가',
    'bank.placeholders.selectCountry': '국가를 선택하세요',
    'bank.currency': '통화',
    'bank.placeholders.selectCurrency': '통화 선택',
    'bank.bankName': '은행명',
    'bank.placeholders.bankName': '은행명을 입력하세요',
    'bank.accountType': '계좌 유형',
    'bank.placeholders.selectAccountType': '계좌 유형 선택',
    'bank.checkingAccount': '당좌예금',
    'bank.savingsAccount': '적금',
    'bank.accountNumber': '계좌번호',
    'bank.placeholders.accountNumber': '계좌번호를 입력하세요',
    'bank.routingNumber': '라우팅 번호',
    'bank.placeholders.routingNumber': '라우팅 번호를 입력하세요',
    'bank.bankAddress': '은행 주소',
    'bank.streetAddress': '도로명 주소',
    'bank.placeholders.streetAddress': '도로명 주소를 입력하세요',
    'bank.city': '시/구',
    'bank.placeholders.city': '시/구를 입력하세요',
    'bank.stateProvince': '시/도',
    'bank.placeholders.stateProvince': '시/도를 입력하세요',
    'bank.zipCode': '우편번호',
    ...
    // Countries
    'countries.unitedStates': '미국',
    'countries.canada': '캐나다',
    'countries.unitedKingdom': '영국',
    'countries.germany': '독일',
    'countries.france': '프랑스',
    'countries.japan': '일본',
    'countries.australia': '호주',
    'countries.singapore': '싱가포르',
    'countries.hongKong': '홍콩',
    'countries.southKorea': '대한민국',

    // Currencies
    'currencies.usd': 'USD - 미국 달러',
    'currencies.eur': 'EUR - 유로',
    'currencies.gbp': 'GBP - 영국 파운드',
    'currencies.jpy': 'JPY - 일본 엔',
    'currencies.cad': 'CAD - 캐나다 달러',
    'currencies.aud': 'AUD - 호주 달러',
    'currencies.sgd': 'SGD - 싱가포르 달러',
    'currencies.hkd': 'HKD - 홍콩 달러',
    'currencies.krw': 'KRW - 한국 원',

    // Credit Cards
    'creditCards.title': '신용카드',
    'creditCards.subtitle': '결제 수단',
    'creditCards.description': '신용카드와 결제 수단을 관리하세요.',
    ...
    'changePassword.changeButton': '비밀번호 변경',
    ...
    'about.countries': '서비스 제공 국가',
    'about.milestone2023Founded': '플랫폼 설립',
    'about.milestone2023Launch': '베타 출시',
    'about.milestone2024Users': '10K+ 사용자',
    'about.milestone2024Security': '보안 강화',
    ...
    'support.emailSupportDescription': '자세한 답변을 이메일로 받기',
    'support.emailSupportAction': '이메일 보내기',
    ...
    'support.lastName': '성',
    'support.lastNamePlaceholder': '성을 입력하세요',
    'support.emailAddress': '이메일 주소',
    'support.emailPlaceholder': '이메일 주소를 입력하세요',
    'support.subject': '제목',
    'support.subjectGeneral': '일반 문의',
    'support.subjectTechnical': '기술적 문제',
    'support.subjectAccount': '계정 문제',
    ...
    'preferences.categories.home': '가구 & 홈용품',
    'preferences.categories.food': '식품',
    'preferences.categories.electronics': '전자제품',
    'preferences.categories.toys': '완구 & 인형',
    'preferences.categories.stationery': '문구용품',
    'preferences.categories.fashion': '패션',
    'preferences.categories.sports': '스포츠 & 피트니스',
    'preferences.categories.accessories': '시계 & 주얼리',
    ...
    'createOffer.domesticShippingDescription': '국내 배송',
    'createOffer.international': '국제 배송',
    'createOffer.internationalDescription': '전 세계 배송',
    ...
    'createRequest.statePlaceholder': '주/도',
    'createRequest.postalCode': '우편번호',
    'createRequest.postalCodePlaceholder': '우편번호',
    ...
    'transactionPassword.title': '거래 비밀번호',
    'transactionPassword.enableTitle': '거래 비밀번호 활성화',
    'transactionPassword.enableDescription': '결제 및 민감한 거래에 추가 보안 계층을 추가합니다.',
    'transactionPassword.enabled': '활성화됨',
    'transactionPassword.disabled': '비활성화됨',
    'transactionPassword.updatePassword': '비밀번호 업데이트',
    'transactionPassword.setPassword': '비밀번호 설정',
    ...
    'transactionPassword.currentPasswordRequired': '현재 비밀번호가 필요합니다',
    'transactionPassword.newPasswordRequired': '새 비밀번호가 필요합니다',
    'transactionPassword.confirmPasswordRequired': '비밀번호를 확인해주세요',
    'transactionPassword.passwordTooShort': '비밀번호는 최소 6자 이상이어야 합니다',
    'transactionPassword.passwordsDoNotMatch': '비밀번호가 일치하지 않습니다',
    'transactionPassword.requirements': '비밀번호 요구사항',
    'transactionPassword.requirementLength': '최소 6자 이상',
    'transactionPassword.requirementMatch': '비밀번호 일치',
    'transactionPassword.infoTitle': '거래 비밀번호란 무엇인가요?',
    'transactionPassword.infoDescription': '거래 비밀번호는 결제 및 민감한 작업에 추가 보안을 제공합니다. 로그인 비밀번호와 다르며 금융 거래를 보호하는 데 도움이 됩니다.',

    // Biometric Authentication
    'biometricAuth.title': '생체 인증',
    'biometricAuth.enableBiometric': '생체 인증 활성화',
    'biometricAuth.enableDescription': '지문 또는 얼굴 인식을 사용하여 안전한 인증을 수행합니다',
    'biometricAuth.faceIdTitle': 'Face ID',
    'biometricAuth.faceIdDescription': '얼굴 인식을 사용하여 앱 잠금 해제 및 거래 인증을 수행합니다',
    'biometricAuth.touchIdTitle': 'Touch ID',
    'biometricAuth.touchIdDescription': '지문을 사용하여 앱 잠금 해제 및 거래 인증을 수행합니다',
    'biometricAuth.deviceSecurityTitle': '기기 보안',
    'biometricAuth.deviceSecurityDescription': '생체 인증 데이터는 기기에 안전하게 저장되며 절대 공유되지 않습니다',
    'biometricAuth.securityNoticeTitle': '보안 및 개인정보 보호',
    'biometricAuth.securityPoint1': '생체 인증 데이터가 기기를 떠나지 않습니다',
    'biometricAuth.securityPoint2': '인증은 기기에서 로컬로 수행됩니다',
    'biometricAuth.securityPoint3': '언제든지 생체 인증을 비활성화할 수 있습니다',
    'biometricAuth.securityPoint4': '비밀번호는 여전히 주요 보안 방법입니다',
    'biometricAuth.biometricActive': '생체 인증이 활성화됨',
    'biometricAuth.biometricActiveDescription': '이제 안전한 액세스를 위해 생체 인증을 사용할 수 있습니다',
  }
};