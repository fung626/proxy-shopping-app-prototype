...
CREATE TABLE IF NOT EXISTS orders (
    ...
    -- Agent commission
    agent_commission_rate NUMERIC(5, 2) DEFAULT 10.00,
    agent_commission_amount NUMERIC(10, 2),
...
INSERT INTO "public"."orders" (
    ...
    "delivery_method", "delivery_address", "tracking_number", "estimated_delivery_date",
...
('a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'ORD-20251110-001000', 
 ...
 'Order for multi-functional storage box from Guangzhou', 10.00, 8.50,
...
('b2c3d4e5-f6a7-8901-bcde-f12345678901', 'ORD-20251101-001001',
 ...
 'Rare Pokemon cards from Tokyo Pokemon Center', 10.00, 17.50,
...
('c3d4e5f6-a7b8-9012-cdef-123456789012', 'ORD-20251112-001002',
 ...
 'High quality kitchen towels bulk pack', 10.00, 3.50,
...
('d4e5f6a7-b8c9-0123-def0-234567890123', 'ORD-20251103-001003',
 ...
 'Professional Japanese chef knife from Tsukiji Market', 10.00, 32.50,
...
('e5f6a7b8-c9d0-1234-ef01-345678901234', 'ORD-20251104-001004',
 ...
 'Korean skincare set for glass skin from Myeongdong', 10.00, 14.00,
...
('f6a7b8c9-d0e1-2345-f012-456789012345', 'ORD-20251105-001005',
 ...
 'Vintage British rock band t-shirts from Camden Market', 10.00, 9.00,
...
('a7b8c9d0-e1f2-3456-0123-567890123456', 'ORD-20251106-001006',
 ...
 'German mechanical keyboard with Cherry MX switches', 10.00, 30.00,
...
('b8c9d0e1-f2a3-4567-1234-678901234567', 'ORD-20251107-001007',
 ...
 'Swiss watch repair tools and parts from Geneva', 10.00, 35.00,
...
('c9d0e1f2-a3b4-5678-2345-789012345678', 'ORD-20251108-001008',
 ...
 'Traditional Chinese calligraphy brushes and inkstone', 10.00, 8.00,
...
('d0e1f2a3-b4c5-6789-3456-890123456789', 'ORD-20251111-001009',
 ...
 NULL, NULL,
 'Taylor Swift concert tickets - VIP section', 10.00, 165.00,
...
('a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'pending_payment', '264cb457-c21d-47d0-b56e-1149b958d625', 'Order created', '2025-11-10 13:30:00+00'),
('a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'payment_confirmed', '264cb457-c21d-47d0-b56e-1149b958d625', 'Payment received', '2025-11-10 14:00:00+00'),
('a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'processing', '01debdb5-7784-439f-870c-37ea485042bc', 'Agent confirmed order', '2025-11-10 15:00:00+00'),
('a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'shipped', '01debdb5-7784-439f-870c-37ea485042bc', 'Package shipped with tracking', '2025-11-12 09:00:00+00'),
('a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'delivered', NULL, 'Package delivered successfully', '2025-11-14 16:00:00+00'),
('a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'completed', '264cb457-c21d-47d0-b56e-1149b958d625', 'Order completed by client', '2025-11-15 10:00:00+00'),

-- Order 2 history (In Transit)
('b2c3d4e5-f6a7-8901-bcde-f12345678901', 'pending_payment', '01debdb5-7784-439f-870c-37ea485042bc', 'Order created', '2025-11-01 10:30:00+00'),
('b2c3d4e5-f6a7-8901-bcde-f12345678901', 'payment_confirmed', '01debdb5-7784-439f-870c-37ea485042bc', 'Payment confirmed', '2025-11-01 11:00:00+00'),
('b2c3d4e5-f6a7-8901-bcde-f12345678901', 'processing', '264cb457-c21d-47d0-b56e-1149b958d625', 'Shopping for Pokemon cards', '2025-11-02 10:00:00+00'),
('b2c3d4e5-f6a7-8901-bcde-f12345678901', 'shipped', '264cb457-c21d-47d0-b56e-1149b958d625', 'Shipped from Tokyo', '2025-11-05 14:00:00+00'),
('b2c3d4e5-f6a7-8901-bcde-f12345678901', 'in_transit', NULL, 'Package in transit to USA', '2025-11-08 08:00:00+00'),

-- Order 3 history (Shipped)
('c3d4e5f6-a7b8-9012-cdef-123456789012', 'pending_payment', '01debdb5-7784-439f-870c-37ea485042bc', 'Order created', '2025-11-12 14:30:00+00'),
('c3d4e5f6-a7b8-9012-cdef-123456789012', 'payment_confirmed', '01debdb5-7784-439f-870c-37ea485042bc', 'Payment received', '2025-11-12 15:00:00+00'),
('c3d4e5f6-a7b8-9012-cdef-123456789012', 'processing', '264cb457-c21d-47d0-b56e-1149b958d625', 'Purchasing kitchen towels', '2025-11-13 10:00:00+00'),
('c3d4e5f6-a7b8-9012-cdef-123456789012', 'shipped', '264cb457-c21d-47d0-b56e-1149b958d625', 'Package shipped to Hong Kong', '2025-11-14 16:00:00+00'),

-- Order 4 history (Processing)
('d4e5f6a7-b8c9-0123-def0-234567890123', 'pending_payment', '264cb457-c21d-47d0-b56e-1149b958d625', 'Order created', '2025-11-03 15:30:00+00'),
('d4e5f6a7-b8c9-0123-def0-234567890123', 'payment_confirmed', '264cb457-c21d-47d0-b56e-1149b958d625', 'Payment confirmed', '2025-11-03 16:00:00+00'),
('d4e5f6a7-b8c9-0123-def0-234567890123', 'processing', '01debdb5-7784-439f-870c-37ea485042bc', 'Sourcing Japanese chef knife', '2025-11-04 09:00:00+00'),

-- Order 5 history (Delivered)
('e5f6a7b8-c9d0-1234-ef01-345678901234', 'pending_payment', '01debdb5-7784-439f-870c-37ea485042bc', 'Order created', '2025-11-04 09:30:00+00'),
('e5f6a7b8-c9d0-1234-ef01-345678901234', 'payment_confirmed', '01debdb5-7784-439f-870c-37ea485042bc', 'Payment received', '2025-11-04 10:00:00+00'),
('e5f6a7b8-c9d0-1234-ef01-345678901234', 'processing', '264cb457-c21d-47d0-b56e-1149b958d625', 'Shopping in Myeongdong', '2025-11-05 11:00:00+00'),
('e5f6a7b8-c9d0-1234-ef01-345678901234', 'shipped', '264cb457-c21d-47d0-b56e-1149b958d625', 'Shipped from Seoul', '2025-11-08 15:00:00+00'),
('e5f6a7b8-c9d0-1234-ef01-345678901234', 'delivered', NULL, 'Delivered to New York', '2025-11-14 14:00:00+00'),

-- Order 6 history (Completed)
('f6a7b8c9-d0e1-2345-f012-456789012345', 'pending_payment', '264cb457-c21d-47d0-b56e-1149b958d625', 'Order created', '2025-11-05 17:00:00+00'),
('f6a7b8c9-d0e1-2345-f012-456789012345', 'payment_confirmed', '264cb457-c21d-47d0-b56e-1149b958d625', 'Payment via PayPal', '2025-11-05 17:30:00+00'),
('f6a7b8c9-d0e1-2345-f012-456789012345', 'processing', '01debdb5-7784-439f-870c-37ea485042bc', 'Found vintage t-shirts at Camden', '2025-11-06 10:00:00+00'),
('f6a7b8c9-d0e1-2345-f012-456789012345', 'shipped', '01debdb5-7784-439f-870c-37ea485042bc', 'Shipped from London', '2025-11-09 13:00:00+00'),
('f6a7b8c9-d0e1-2345-f012-456789012345', 'delivered', NULL, 'Delivered to Toronto', '2025-11-12 10:00:00+00'),
('f6a7b8c9-d0e1-2345-f012-456789012345', 'completed', '264cb457-c21d-47d0-b56e-1149b958d625', 'Client confirmed receipt', '2025-11-13 12:00:00+00'),

-- Order 7 history (In Transit)
('a7b8c9d0-e1f2-3456-0123-567890123456', 'pending_payment', '01debdb5-7784-439f-870c-37ea485042bc', 'Order created', '2025-11-06 11:30:00+00'),
('a7b8c9d0-e1f2-3456-0123-567890123456', 'payment_confirmed', '01debdb5-7784-439f-870c-37ea485042bc', 'Payment confirmed', '2025-11-06 12:00:00+00'),
('a7b8c9d0-e1f2-3456-0123-567890123456', 'processing', '264cb457-c21d-47d0-b56e-1149b958d625', 'Sourcing German keyboard', '2025-11-07 14:00:00+00'),
('a7b8c9d0-e1f2-3456-0123-567890123456', 'shipped', '264cb457-c21d-47d0-b56e-1149b958d625', 'Shipped from Berlin', '2025-11-10 16:00:00+00'),
('a7b8c9d0-e1f2-3456-0123-567890123456', 'in_transit', NULL, 'En route to San Francisco', '2025-11-13 09:00:00+00'),

-- Order 8 history (Processing)
('b8c9d0e1-f2a3-4567-1234-678901234567', 'pending_payment', '264cb457-c21d-47d0-b56e-1149b958d625', 'Order created', '2025-11-07 13:30:00+00'),
('b8c9d0e1-f2a3-4567-1234-678901234567', 'payment_confirmed', '264cb457-c21d-47d0-b56e-1149b958d625', 'Payment received', '2025-11-07 14:00:00+00'),
('b8c9d0e1-f2a3-4567-1234-678901234567', 'processing', '01debdb5-7784-439f-870c-37ea485042bc', 'Sourcing Swiss watch tools in Geneva', '2025-11-08 10:00:00+00'),

-- Order 9 history (Shipped)
('c9d0e1f2-a3b4-5678-2345-789012345678', 'pending_payment', '01debdb5-7784-439f-870c-37ea485042bc', 'Order created', '2025-11-08 08:30:00+00'),
('c9d0e1f2-a3b4-5678-2345-789012345678', 'payment_confirmed', '01debdb5-7784-439f-870c-37ea485042bc', 'Payment via PayPal', '2025-11-08 09:00:00+00'),
('c9d0e1f2-a3b4-5678-2345-789012345678', 'processing', '264cb457-c21d-47d0-b56e-1149b958d625', 'Shopping for calligraphy supplies in Beijing', '2025-11-09 10:00:00+00'),
('c9d0e1f2-a3b4-5678-2345-789012345678', 'shipped', '264cb457-c21d-47d0-b56e-1149b958d625', 'Shipped from Beijing', '2025-11-14 15:00:00+00'),

-- Order 10 history (Payment Confirmed)
('d0e1f2a3-b4c5-6789-3456-890123456789', 'pending_payment', '01debdb5-7784-439f-870c-37ea485042bc', 'Order created', '2025-11-11 09:30:00+00'),
('d0e1f2a3-b4c5-6789-3456-890123456789', 'payment_confirmed', '01debdb5-7784-439f-870c-37ea485042bc', 'Payment confirmed for concert tickets', '2025-11-11 10:00:00+00');
